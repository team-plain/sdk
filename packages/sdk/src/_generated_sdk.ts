...
export class CompanyModel {
  ...
  public get accountOwner(): Promise<UserModel | undefined> {
    ...
    return this._client
      .request<UserQuery, UserQueryVariables>(UserDocument, { userId: id } as UserQueryVariables)
  ...
  public get tier(): Promise<TierModel | undefined> {
    ...
    if (!id) return Promise.resolve(undefined);
    return this._client
      .request<TierQuery, TierQueryVariables>(TierDocument, { tierId: id } as TierQueryVariables)
...
export class CustomerModel {
  ...
  public get company(): Promise<CompanyModel | undefined> {
    ...
    if (!id) return Promise.resolve(undefined);
    return this._client
      .request<CompanyQuery, CompanyQueryVariables>(CompanyDocument, {
        companyId: id,
      } as CompanyQueryVariables)
...
export class CustomerGroupMembershipModel {
  ...
  public get customerGroup(): Promise<CustomerGroupModel | undefined> {
    ...
    if (!id) return Promise.resolve(undefined);
    return this._client
      .request<CustomerGroupQuery, CustomerGroupQueryVariables>(CustomerGroupDocument, {
        customerGroupId: id,
      } as CustomerGroupQueryVariables)
      .then((r) =>
        r.customerGroup ? new CustomerGroupModel(this._client, r.customerGroup) : undefined,
      );
  }
}
...
export class EmailModel {
  ...
  public get customer(): Promise<CustomerModel | undefined> {
    ...
    if (!id) return Promise.resolve(undefined);
    return this._client
      .request<CustomerQuery, CustomerQueryVariables>(CustomerDocument, {
        customerId: id,
  ...
  public get thread(): Promise<ThreadModel | undefined> {
    ...
    if (!id) return Promise.resolve(undefined);
    return this._client
      .request<ThreadQuery, ThreadQueryVariables>(ThreadDocument, {
        threadId: id,
      } as ThreadQueryVariables)
...
export class HelpCenterArticleModel {
  ...
  public get articleGroup(): Promise<HelpCenterArticleGroupModel | undefined> {
    ...
    if (!id) return Promise.resolve(undefined);
    return this._client
      .request<HelpCenterArticleGroupQuery, HelpCenterArticleGroupQueryVariables>(
        HelpCenterArticleGroupDocument,
        { id: id } as HelpCenterArticleGroupQueryVariables,
      )
      .then((r) =>
        r.helpCenterArticleGroup
          ? new HelpCenterArticleGroupModel(this._client, r.helpCenterArticleGroup)
          : undefined,
      );
  }
}
...
export class LabelModel {
  ...
  public get labelType(): Promise<LabelTypeModel | undefined> {
    ...
    if (!id) return Promise.resolve(undefined);
    return this._client
      .request<LabelTypeQuery, LabelTypeQueryVariables>(LabelTypeDocument, {
        labelTypeId: id,
      } as LabelTypeQueryVariables)
...
export class RoleModel {
  ...
  public get customRole(): Promise<CustomRoleModel | undefined> {
    ...
    if (!id) return Promise.resolve(undefined);
    return this._client
      .request<CustomRoleQuery, CustomRoleQueryVariables>(CustomRoleDocument, {
        customRoleId: id,
      } as CustomRoleQueryVariables)
...
export class TaskModel {
  ...
  public get tenant(): Promise<TenantModel | undefined> {
    ...
    if (!id) return Promise.resolve(undefined);
    return this._client
      .request<TenantQuery, TenantQueryVariables>(TenantDocument, {
        tenantId: id,
      } as TenantQueryVariables)
...
export class UserModel {
  ...
  public get defaultSavedThreadsView(): Promise<SavedThreadsViewModel | undefined> {
    ...
    if (!id) return Promise.resolve(undefined);
    return this._client
      .request<SavedThreadsViewQuery, SavedThreadsViewQueryVariables>(SavedThreadsViewDocument, {
        savedThreadsViewId: id,
      } as SavedThreadsViewQueryVariables)
      .then((r) =>
        r.savedThreadsView
          ? new SavedThreadsViewModel(this._client, r.savedThreadsView)
          : undefined,
      );
  }
}
...
export class WorkspaceInviteModel {
  ...
  public get workspace(): Promise<WorkspaceModel | undefined> {
    ...
    if (!id) return Promise.resolve(undefined);
    return this._client
      .request<WorkspaceQuery, WorkspaceQueryVariables>(WorkspaceDocument, {
        workspaceId: id,
      } as WorkspaceQueryVariables)
...
export class PlainSdk {
  ...
  async activeThreadCluster(
    variables: ActiveThreadClusterQueryVariables,
  ): Promise<ThreadClusterModel> {
  ...
  async aiToneRules(
    variables: AiToneRulesQueryVariables,
  ): Promise<PlainConnection<AiToneRuleModel>> {
  ...
  async autoresponders(
    variables: AutorespondersQueryVariables,
  ): Promise<PlainConnection<AutoresponderModel>> {
    ...
    return new PlainConnection<AutoresponderModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.autoresponders({ ...variables, ...cursor } as AutorespondersQueryVariables),
    });
  }

  async billingPlans(
    variables: BillingPlansQueryVariables,
  ): Promise<PlainConnection<BillingPlanModel>> {
    ...
    return new PlainConnection<BillingPlanModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.billingPlans({ ...variables, ...cursor } as BillingPlansQueryVariables),
    });
  }
  ...
  async businessHoursSlots(): Promise<BusinessHoursSlotModel[]> {
    ...
    return (response.businessHoursSlots ?? []).map(
      (d) => new BusinessHoursSlotModel(this._client, d),
    );
  }
  ...
  async connectedDiscordChannels(
    variables: ConnectedDiscordChannelsQueryVariables,
  ): Promise<PlainConnection<ConnectedDiscordChannelModel>> {
    const response = await this._client.request<
      ConnectedDiscordChannelsQuery,
      ConnectedDiscordChannelsQueryVariables
    ...
    return new PlainConnection<ConnectedDiscordChannelModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.connectedDiscordChannels({
          ...variables,
          ...cursor,
        } as ConnectedDiscordChannelsQueryVariables),
    });
  }

  async connectedMSTeamsChannels(
    variables: ConnectedMsTeamsChannelsQueryVariables,
  ): Promise<PlainConnection<ConnectedMSTeamsChannelModel>> {
    const response = await this._client.request<
      ConnectedMsTeamsChannelsQuery,
      ConnectedMsTeamsChannelsQueryVariables
    ...
    return new PlainConnection<ConnectedMSTeamsChannelModel>({
      ...
      fetch: (cursor) =>
        this.connectedMSTeamsChannels({
          ...variables,
          ...cursor,
        } as ConnectedMsTeamsChannelsQueryVariables),
    });
  }

  async connectedSlackChannel(
    variables: ConnectedSlackChannelQueryVariables,
  ): Promise<ConnectedSlackChannelModel> {
    const response = await this._client.request<
      ConnectedSlackChannelQuery,
      ConnectedSlackChannelQueryVariables
  ...
  async connectedSlackChannels(
    variables: ConnectedSlackChannelsQueryVariables,
  ): Promise<PlainConnection<ConnectedSlackChannelModel>> {
    const response = await this._client.request<
      ConnectedSlackChannelsQuery,
      ConnectedSlackChannelsQueryVariables
    ...
    return new PlainConnection<ConnectedSlackChannelModel>({
      ...
      totalCount: conn.totalCount,
      fetch: (cursor) =>
        this.connectedSlackChannels({
          ...variables,
          ...cursor,
        } as ConnectedSlackChannelsQueryVariables),
    });
  }

  async cursorRepositories(
    variables: CursorRepositoriesQueryVariables,
  ): Promise<CursorRepositoriesQuery["cursorRepositories"]> {
    const response = await this._client.request<
      CursorRepositoriesQuery,
      CursorRepositoriesQueryVariables
  ...
  ): Promise<PlainConnection<CustomRoleModel>> {
  ...
  async customerByExternalId(
    variables: CustomerByExternalIdQueryVariables,
  ...
  async customerCardConfig(
    variables: CustomerCardConfigQueryVariables,
  ): Promise<CustomerCardConfigModel> {
    const response = await this._client.request<
      CustomerCardConfigQuery,
      CustomerCardConfigQueryVariables
  ...
  async customerCardConfigs(): Promise<CustomerCardConfigModel[]> {
    ...
    return (response.customerCardConfigs ?? []).map(
      (d) => new CustomerCardConfigModel(this._client, d),
    );
  }

  async customerCardInstances(
    variables: CustomerCardInstancesQueryVariables,
  ): Promise<CustomerCardInstancesQuery["customerCardInstances"]> {
    const response = await this._client.request<
      CustomerCardInstancesQuery,
      CustomerCardInstancesQueryVariables
  ...
  async customerGroups(
    variables: CustomerGroupsQueryVariables,
  ): Promise<PlainConnection<CustomerGroupModel>> {
    ...
    return new PlainConnection<CustomerGroupModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.customerGroups({ ...variables, ...cursor } as CustomerGroupsQueryVariables),
    });
  }
  ...
  async customerSurveys(
    variables: CustomerSurveysQueryVariables,
  ): Promise<PlainConnection<CustomerSurveyModel>> {
    const response = await this._client.request<
      CustomerSurveysQuery,
      CustomerSurveysQueryVariables
    ...
    return new PlainConnection<CustomerSurveyModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.customerSurveys({ ...variables, ...cursor } as CustomerSurveysQueryVariables),
    });
  }
  ...
  async deletedThreads(
    variables: DeletedThreadsQueryVariables,
  ): Promise<PlainConnection<DeletedThreadModel>> {
    ...
    return new PlainConnection<DeletedThreadModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.deletedThreads({ ...variables, ...cursor } as DeletedThreadsQueryVariables),
    });
  }

  async enabledAiToneRulesText(): Promise<
    NonNullable<EnabledAiToneRulesTextQuery["enabledAiToneRulesText"]>
  > {
  ...
  async escalationPaths(
    variables: EscalationPathsQueryVariables,
  ): Promise<PlainConnection<EscalationPathModel>> {
    const response = await this._client.request<
      EscalationPathsQuery,
      EscalationPathsQueryVariables
    ...
    return new PlainConnection<EscalationPathModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.escalationPaths({ ...variables, ...cursor } as EscalationPathsQueryVariables),
    });
  }

  async generatedReplies(
    variables: GeneratedRepliesQueryVariables,
  ): Promise<GeneratedReplyModel[]> {
    const response = await this._client.request<
      GeneratedRepliesQuery,
      GeneratedRepliesQueryVariables
  ...
  async getMSTeamsMembersForChannel(
    variables: GetMsTeamsMembersForChannelQueryVariables,
  ): Promise<MSTeamsChannelMembersModel> {
    const response = await this._client.request<
      GetMsTeamsMembersForChannelQuery,
      GetMsTeamsMembersForChannelQueryVariables
  ...
  async helpCenterArticle(
    variables: HelpCenterArticleQueryVariables,
  ): Promise<HelpCenterArticleModel> {
    const response = await this._client.request<
      HelpCenterArticleQuery,
      HelpCenterArticleQueryVariables
  ...
  async helpCenterArticleBySlug(
    variables: HelpCenterArticleBySlugQueryVariables,
  ): Promise<HelpCenterArticleModel> {
    const response = await this._client.request<
      HelpCenterArticleBySlugQuery,
      HelpCenterArticleBySlugQueryVariables
  ...
  async helpCenterArticleGroup(
    variables: HelpCenterArticleGroupQueryVariables,
  ): Promise<HelpCenterArticleGroupModel> {
    const response = await this._client.request<
      HelpCenterArticleGroupQuery,
      HelpCenterArticleGroupQueryVariables
  ...
  async helpCenterArticleGroupBySlug(
    variables: HelpCenterArticleGroupBySlugQueryVariables,
  ): Promise<HelpCenterArticleGroupModel> {
    const response = await this._client.request<
      HelpCenterArticleGroupBySlugQuery,
      HelpCenterArticleGroupBySlugQueryVariables
  ...
  async helpCenters(
    variables: HelpCentersQueryVariables,
  ): Promise<PlainConnection<HelpCenterModel>> {
  ...
  async indexedDocuments(
    variables: IndexedDocumentsQueryVariables,
  ): Promise<PlainConnection<IndexedDocumentModel>> {
    const response = await this._client.request<
      IndexedDocumentsQuery,
      IndexedDocumentsQueryVariables
    ...
    return new PlainConnection<IndexedDocumentModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.indexedDocuments({ ...variables, ...cursor } as IndexedDocumentsQueryVariables),
    });
  }

  async issueTrackerFields(
    variables: IssueTrackerFieldsQueryVariables,
  ): Promise<IssueTrackerFieldModel[]> {
    const response = await this._client.request<
      IssueTrackerFieldsQuery,
      IssueTrackerFieldsQueryVariables
    >(IssueTrackerFieldsDocument, variables);
    return (response.issueTrackerFields ?? []).map(
      (d) => new IssueTrackerFieldModel(this._client, d),
    );
  }

  async knowledgeSource(
    variables: KnowledgeSourceQueryVariables,
  ): Promise<NonNullable<KnowledgeSourceQuery["knowledgeSource"]>> {
    const response = await this._client.request<
      KnowledgeSourceQuery,
      KnowledgeSourceQueryVariables
  ...
  async knowledgeSources(
    variables: KnowledgeSourcesQueryVariables,
  ): Promise<KnowledgeSourcesQuery["knowledgeSources"]> {
    const response = await this._client.request<
      KnowledgeSourcesQuery,
      KnowledgeSourcesQueryVariables
  ...
  async labelTypeByExternalId(
    variables: LabelTypeByExternalIdQueryVariables,
  ): Promise<LabelTypeModel> {
    const response = await this._client.request<
      LabelTypeByExternalIdQuery,
      LabelTypeByExternalIdQueryVariables
  ...
  async machineUsers(
    variables: MachineUsersQueryVariables,
  ): Promise<PlainConnection<MachineUserModel>> {
    ...
    return new PlainConnection<MachineUserModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.machineUsers({ ...variables, ...cursor } as MachineUsersQueryVariables),
    });
  }
  ...
  async myFavoritePages(
    variables: MyFavoritePagesQueryVariables,
  ): Promise<PlainConnection<FavoritePageModel>> {
    const response = await this._client.request<
      MyFavoritePagesQuery,
      MyFavoritePagesQueryVariables
    ...
    return new PlainConnection<FavoritePageModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.myFavoritePages({ ...variables, ...cursor } as MyFavoritePagesQueryVariables),
    });
  }

  async myInternalNotifications(
    variables: MyInternalNotificationsQueryVariables,
  ): Promise<PlainConnection<InternalNotificationModel>> {
    const response = await this._client.request<
      MyInternalNotificationsQuery,
      MyInternalNotificationsQueryVariables
    ...
    return new PlainConnection<InternalNotificationModel>({
      ...
      totalCount: conn.totalCount,
      fetch: (cursor) =>
        this.myInternalNotifications({
          ...variables,
          ...cursor,
        } as MyInternalNotificationsQueryVariables),
    });
  }
  ...
  async myLinearInstallationInfo(
    variables: MyLinearInstallationInfoQueryVariables,
  ): Promise<MyLinearInstallationInfoQuery["myLinearInstallationInfo"]> {
    const response = await this._client.request<
      MyLinearInstallationInfoQuery,
      MyLinearInstallationInfoQueryVariables
  ...
  async myLinearIntegrationToken(): Promise<
    NonNullable<MyLinearIntegrationTokenQuery["myLinearIntegrationToken"]>
  > {
    const response = await this._client.request<
      MyLinearIntegrationTokenQuery,
      Record<string, never>
  ...
  async myMSTeamsInstallationInfo(
    variables: MyMsTeamsInstallationInfoQueryVariables,
  ): Promise<MyMsTeamsInstallationInfoQuery["myMSTeamsInstallationInfo"]> {
    const response = await this._client.request<
      MyMsTeamsInstallationInfoQuery,
      MyMsTeamsInstallationInfoQueryVariables
  ...
  async mySlackInstallationInfo(
    variables: MySlackInstallationInfoQueryVariables,
  ): Promise<MySlackInstallationInfoQuery["mySlackInstallationInfo"]> {
    const response = await this._client.request<
      MySlackInstallationInfoQuery,
      MySlackInstallationInfoQueryVariables
  ...
  async myUser(): Promise<UserModel> {
    const response = await this._client.request<MyUserQuery, Record<string, never>>(MyUserDocument);
    if (!response.myUser) {
  ...
  async myWorkspaceInvites(
    variables: MyWorkspaceInvitesQueryVariables,
  ): Promise<PlainConnection<WorkspaceInviteModel>> {
    const response = await this._client.request<
      MyWorkspaceInvitesQuery,
      MyWorkspaceInvitesQueryVariables
    ...
    return new PlainConnection<WorkspaceInviteModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.myWorkspaceInvites({ ...variables, ...cursor } as MyWorkspaceInvitesQueryVariables),
    });
  }

  async myWorkspaces(
    variables: MyWorkspacesQueryVariables,
  ): Promise<PlainConnection<WorkspaceModel>> {
    ...
    return new PlainConnection<WorkspaceModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.myWorkspaces({ ...variables, ...cursor } as MyWorkspacesQueryVariables),
    });
  }
  ...
  async relatedThreads(
    variables: RelatedThreadsQueryVariables,
  ): Promise<ThreadWithDistanceModel[]> {
  ...
  async savedThreadsView(
    variables: SavedThreadsViewQueryVariables,
  ): Promise<SavedThreadsViewModel> {
    const response = await this._client.request<
      SavedThreadsViewQuery,
      SavedThreadsViewQueryVariables
  ...
  async savedThreadsViews(
    variables: SavedThreadsViewsQueryVariables,
  ): Promise<PlainConnection<SavedThreadsViewModel>> {
    const response = await this._client.request<
      SavedThreadsViewsQuery,
      SavedThreadsViewsQueryVariables
    ...
    return new PlainConnection<SavedThreadsViewModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.savedThreadsViews({ ...variables, ...cursor } as SavedThreadsViewsQueryVariables),
    });
  }

  async searchCompanies(
    variables: SearchCompaniesQueryVariables,
  ): Promise<SearchCompaniesQuery["searchCompanies"]> {
    const response = await this._client.request<
      SearchCompaniesQuery,
      SearchCompaniesQueryVariables
  ...
  async searchCustomers(
  ...
  ): Promise<PlainConnection<CustomerModel>> {
    const response = await this._client.request<
      SearchCustomersQuery,
      SearchCustomersQueryVariables
    ...
    return new PlainConnection<CustomerModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.searchCustomers({ ...variables, ...cursor } as SearchCustomersQueryVariables),
    });
  }

  async searchKnowledgeSources(
    variables: SearchKnowledgeSourcesQueryVariables,
  ): Promise<SearchKnowledgeSourcesQuery["searchKnowledgeSources"]> {
    const response = await this._client.request<
      SearchKnowledgeSourcesQuery,
      SearchKnowledgeSourcesQueryVariables
  ...
  async searchSlackUsers(
    variables: SearchSlackUsersQueryVariables,
  ): Promise<PlainConnection<SlackUserModel>> {
    const response = await this._client.request<
      SearchSlackUsersQuery,
      SearchSlackUsersQueryVariables
    ...
    return new PlainConnection<SlackUserModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.searchSlackUsers({ ...variables, ...cursor } as SearchSlackUsersQueryVariables),
    });
  }

  async searchTenants(
    variables: SearchTenantsQueryVariables,
  ): Promise<SearchTenantsQuery["searchTenants"]> {
  ...
  async searchThreadLinkCandidates(
    variables: SearchThreadLinkCandidatesQueryVariables,
  ): Promise<PlainConnection<ThreadLinkCandidateModel>> {
    const response = await this._client.request<
      SearchThreadLinkCandidatesQuery,
      SearchThreadLinkCandidatesQueryVariables
    ...
    return new PlainConnection<ThreadLinkCandidateModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.searchThreadLinkCandidates({
          ...variables,
          ...cursor,
        } as SearchThreadLinkCandidatesQueryVariables),
    });
  }

  async searchThreadSlackUsers(
    variables: SearchThreadSlackUsersQueryVariables,
  ): Promise<PlainConnection<SlackUserModel>> {
    const response = await this._client.request<
      SearchThreadSlackUsersQuery,
      SearchThreadSlackUsersQueryVariables
    ...
    return new PlainConnection<SlackUserModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.searchThreadSlackUsers({
          ...variables,
          ...cursor,
        } as SearchThreadSlackUsersQueryVariables),
    });
  }

  async searchThreads(
    variables: SearchThreadsQueryVariables,
  ): Promise<SearchThreadsQuery["searchThreads"]> {
  ...
  async serviceAuthorization(
    variables: ServiceAuthorizationQueryVariables,
  ): Promise<ServiceAuthorizationModel> {
    const response = await this._client.request<
      ServiceAuthorizationQuery,
      ServiceAuthorizationQueryVariables
  ...
  async serviceAuthorizations(
    variables: ServiceAuthorizationsQueryVariables,
  ): Promise<PlainConnection<ServiceAuthorizationModel>> {
    const response = await this._client.request<
      ServiceAuthorizationsQuery,
      ServiceAuthorizationsQueryVariables
    ...
    return new PlainConnection<ServiceAuthorizationModel>({
      ...
      fetch: (cursor) =>
        this.serviceAuthorizations({
          ...variables,
          ...cursor,
        } as ServiceAuthorizationsQueryVariables),
    });
  }
  ...
  async singleValueMetric(
    variables: SingleValueMetricQueryVariables,
  ): Promise<NonNullable<SingleValueMetricQuery["singleValueMetric"]>> {
    const response = await this._client.request<
      SingleValueMetricQuery,
      SingleValueMetricQueryVariables
  ...
  async tenantFieldSchemas(
    variables: TenantFieldSchemasQueryVariables,
  ): Promise<PlainConnection<TenantFieldSchemaModel>> {
    const response = await this._client.request<
      TenantFieldSchemasQuery,
      TenantFieldSchemasQueryVariables
    ...
    return new PlainConnection<TenantFieldSchemaModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.tenantFieldSchemas({ ...variables, ...cursor } as TenantFieldSchemasQueryVariables),
    });
  }
  ...
  async threadClustersPaginated(
    variables: ThreadClustersPaginatedQueryVariables,
  ): Promise<PlainConnection<ThreadClusterModel>> {
    const response = await this._client.request<
      ThreadClustersPaginatedQuery,
      ThreadClustersPaginatedQueryVariables
    ...
    return new PlainConnection<ThreadClusterModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.threadClustersPaginated({
          ...variables,
          ...cursor,
        } as ThreadClustersPaginatedQueryVariables),
    });
  }

  async threadDiscussion(
    variables: ThreadDiscussionQueryVariables,
  ): Promise<ThreadDiscussionModel> {
    const response = await this._client.request<
      ThreadDiscussionQuery,
      ThreadDiscussionQueryVariables
  ...
  async threadFieldSchema(
    variables: ThreadFieldSchemaQueryVariables,
  ): Promise<ThreadFieldSchemaModel> {
    const response = await this._client.request<
      ThreadFieldSchemaQuery,
      ThreadFieldSchemaQueryVariables
  ...
  async threadFieldSchemas(
    variables: ThreadFieldSchemasQueryVariables,
  ): Promise<PlainConnection<ThreadFieldSchemaModel>> {
    const response = await this._client.request<
      ThreadFieldSchemasQuery,
      ThreadFieldSchemasQueryVariables
    ...
    return new PlainConnection<ThreadFieldSchemaModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.threadFieldSchemas({ ...variables, ...cursor } as ThreadFieldSchemasQueryVariables),
    });
  }

  async threadLinkGroups(
    variables: ThreadLinkGroupsQueryVariables,
  ): Promise<PlainConnection<ThreadLinkGroupModel>> {
    const response = await this._client.request<
      ThreadLinkGroupsQuery,
      ThreadLinkGroupsQueryVariables
    ...
    return new PlainConnection<ThreadLinkGroupModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.threadLinkGroups({ ...variables, ...cursor } as ThreadLinkGroupsQueryVariables),
    });
  }
  ...
  async timeSeriesMetric(
    variables: TimeSeriesMetricQueryVariables,
  ): Promise<TimeSeriesMetricModel> {
    const response = await this._client.request<
      TimeSeriesMetricQuery,
      TimeSeriesMetricQueryVariables
  ...
  async timelineEntries(
    variables: TimelineEntriesQueryVariables,
  ): Promise<PlainConnection<TimelineEntryModel>> {
    const response = await this._client.request<
      TimelineEntriesQuery,
      TimelineEntriesQueryVariables
    ...
    return new PlainConnection<TimelineEntryModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.timelineEntries({ ...variables, ...cursor } as TimelineEntriesQueryVariables),
    });
  }
  ...
  async userAuthDiscordChannelInstallationInfo(
    variables: UserAuthDiscordChannelInstallationInfoQueryVariables,
  ): Promise<
    UserAuthDiscordChannelInstallationInfoQuery["userAuthDiscordChannelInstallationInfo"]
  > {
    const response = await this._client.request<
      UserAuthDiscordChannelInstallationInfoQuery,
      UserAuthDiscordChannelInstallationInfoQueryVariables
  ...
  async userAuthDiscordChannelIntegration(
    variables: UserAuthDiscordChannelIntegrationQueryVariables,
  ): Promise<UserAuthDiscordChannelIntegrationModel> {
    const response = await this._client.request<
      UserAuthDiscordChannelIntegrationQuery,
      UserAuthDiscordChannelIntegrationQueryVariables
    ...
    return new UserAuthDiscordChannelIntegrationModel(
      this._client,
      response.userAuthDiscordChannelIntegration,
    );
  }

  async userAuthDiscordChannelIntegrations(
    variables: UserAuthDiscordChannelIntegrationsQueryVariables,
  ): Promise<PlainConnection<UserAuthDiscordChannelIntegrationModel>> {
    const response = await this._client.request<
      UserAuthDiscordChannelIntegrationsQuery,
      UserAuthDiscordChannelIntegrationsQueryVariables
    ...
    return new PlainConnection<UserAuthDiscordChannelIntegrationModel>({
      nodes: conn.edges.map(
        (e) => new UserAuthDiscordChannelIntegrationModel(this._client, e.node),
      ),
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.userAuthDiscordChannelIntegrations({
          ...variables,
          ...cursor,
        } as UserAuthDiscordChannelIntegrationsQueryVariables),
    });
  }

  async userAuthSlackInstallationInfo(
    variables: UserAuthSlackInstallationInfoQueryVariables,
  ): Promise<UserAuthSlackInstallationInfoQuery["userAuthSlackInstallationInfo"]> {
    const response = await this._client.request<
      UserAuthSlackInstallationInfoQuery,
      UserAuthSlackInstallationInfoQueryVariables
  ...
  async userAuthSlackIntegration(
    variables: UserAuthSlackIntegrationQueryVariables,
  ): Promise<UserAuthSlackIntegrationModel> {
    const response = await this._client.request<
      UserAuthSlackIntegrationQuery,
      UserAuthSlackIntegrationQueryVariables
  ...
  async userAuthSlackIntegrationByThreadId(
    variables: UserAuthSlackIntegrationByThreadIdQueryVariables,
  ): Promise<UserAuthSlackIntegrationModel> {
    const response = await this._client.request<
      UserAuthSlackIntegrationByThreadIdQuery,
      UserAuthSlackIntegrationByThreadIdQueryVariables
    ...
    return new UserAuthSlackIntegrationModel(
      this._client,
      response.userAuthSlackIntegrationByThreadId,
    );
  }
  ...
  async userSlackChannelMemberships(
    variables: UserSlackChannelMembershipsQueryVariables,
  ): Promise<UserSlackChannelMembershipsQuery["userSlackChannelMemberships"]> {
    const response = await this._client.request<
      UserSlackChannelMembershipsQuery,
      UserSlackChannelMembershipsQueryVariables
  ...
  async webhookTargets(
    variables: WebhookTargetsQueryVariables,
  ): Promise<PlainConnection<WebhookTargetModel>> {
    ...
    return new PlainConnection<WebhookTargetModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.webhookTargets({ ...variables, ...cursor } as WebhookTargetsQueryVariables),
    });
  }

  async webhookVersions(
    variables: WebhookVersionsQueryVariables,
  ): Promise<WebhookVersionsQuery["webhookVersions"]> {
    const response = await this._client.request<
      WebhookVersionsQuery,
      WebhookVersionsQueryVariables
  ...
  async workOSConfiguration(): Promise<
    NonNullable<WorkOsConfigurationQuery["workOSConfiguration"]>
  > {
  ...
  async workflowExecution(
    variables: WorkflowExecutionQueryVariables,
  ...
  async workflowExecutions(
    variables: WorkflowExecutionsQueryVariables,
  ): Promise<PlainConnection<WorkflowExecutionModel>> {
    const response = await this._client.request<
      WorkflowExecutionsQuery,
      WorkflowExecutionsQueryVariables
    ...
    return new PlainConnection<WorkflowExecutionModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.workflowExecutions({ ...variables, ...cursor } as WorkflowExecutionsQueryVariables),
    });
  }

  async workflowExecutionsByEntity(
    variables: WorkflowExecutionsByEntityQueryVariables,
  ): Promise<PlainConnection<WorkflowExecutionModel>> {
    const response = await this._client.request<
      WorkflowExecutionsByEntityQuery,
      WorkflowExecutionsByEntityQueryVariables
    ...
    return new PlainConnection<WorkflowExecutionModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.workflowExecutionsByEntity({
          ...variables,
          ...cursor,
        } as WorkflowExecutionsByEntityQueryVariables),
    });
  }
  ...
  async workflowRules(
    variables: WorkflowRulesQueryVariables,
  ): Promise<PlainConnection<WorkflowRuleModel>> {
    ...
    return new PlainConnection<WorkflowRuleModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.workflowRules({ ...variables, ...cursor } as WorkflowRulesQueryVariables),
    });
  }
  ...
  async workspaceDiscordChannelInstallationInfo(
    variables: WorkspaceDiscordChannelInstallationInfoQueryVariables,
  ): Promise<
    WorkspaceDiscordChannelInstallationInfoQuery["workspaceDiscordChannelInstallationInfo"]
  > {
    const response = await this._client.request<
      WorkspaceDiscordChannelInstallationInfoQuery,
      WorkspaceDiscordChannelInstallationInfoQueryVariables
  ...
  async workspaceDiscordChannelIntegration(
    variables: WorkspaceDiscordChannelIntegrationQueryVariables,
  ): Promise<WorkspaceDiscordChannelIntegrationModel> {
    const response = await this._client.request<
      WorkspaceDiscordChannelIntegrationQuery,
      WorkspaceDiscordChannelIntegrationQueryVariables
    ...
    return new WorkspaceDiscordChannelIntegrationModel(
      this._client,
      response.workspaceDiscordChannelIntegration,
    );
  }

  async workspaceDiscordChannelIntegrations(
    variables: WorkspaceDiscordChannelIntegrationsQueryVariables,
  ): Promise<PlainConnection<WorkspaceDiscordChannelIntegrationModel>> {
    const response = await this._client.request<
      WorkspaceDiscordChannelIntegrationsQuery,
      WorkspaceDiscordChannelIntegrationsQueryVariables
    ...
    return new PlainConnection<WorkspaceDiscordChannelIntegrationModel>({
      nodes: conn.edges.map(
        (e) => new WorkspaceDiscordChannelIntegrationModel(this._client, e.node),
      ),
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.workspaceDiscordChannelIntegrations({
          ...variables,
          ...cursor,
        } as WorkspaceDiscordChannelIntegrationsQueryVariables),
    });
  }

  async workspaceDiscordIntegration(
    variables: WorkspaceDiscordIntegrationQueryVariables,
  ): Promise<WorkspaceDiscordIntegrationModel> {
    const response = await this._client.request<
      WorkspaceDiscordIntegrationQuery,
      WorkspaceDiscordIntegrationQueryVariables
  ...
  async workspaceDiscordIntegrations(
    variables: WorkspaceDiscordIntegrationsQueryVariables,
  ): Promise<PlainConnection<WorkspaceDiscordIntegrationModel>> {
    const response = await this._client.request<
      WorkspaceDiscordIntegrationsQuery,
      WorkspaceDiscordIntegrationsQueryVariables
    ...
    return new PlainConnection<WorkspaceDiscordIntegrationModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.workspaceDiscordIntegrations({
          ...variables,
          ...cursor,
        } as WorkspaceDiscordIntegrationsQueryVariables),
    });
  }
  ...
  async workspaceInvites(
    variables: WorkspaceInvitesQueryVariables,
  ): Promise<PlainConnection<WorkspaceInviteModel>> {
    const response = await this._client.request<
      WorkspaceInvitesQuery,
      WorkspaceInvitesQueryVariables
    ...
    return new PlainConnection<WorkspaceInviteModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.workspaceInvites({ ...variables, ...cursor } as WorkspaceInvitesQueryVariables),
    });
  }

  async workspaceMSTeamsInstallationInfo(
    variables: WorkspaceMsTeamsInstallationInfoQueryVariables,
  ): Promise<WorkspaceMsTeamsInstallationInfoQuery["workspaceMSTeamsInstallationInfo"]> {
    const response = await this._client.request<
      WorkspaceMsTeamsInstallationInfoQuery,
      WorkspaceMsTeamsInstallationInfoQueryVariables
  ...
  async workspaceSlackChannelInstallationInfo(
    variables: WorkspaceSlackChannelInstallationInfoQueryVariables,
  ): Promise<WorkspaceSlackChannelInstallationInfoQuery["workspaceSlackChannelInstallationInfo"]> {
    const response = await this._client.request<
      WorkspaceSlackChannelInstallationInfoQuery,
      WorkspaceSlackChannelInstallationInfoQueryVariables
  ...
  async workspaceSlackChannelIntegration(
    variables: WorkspaceSlackChannelIntegrationQueryVariables,
  ): Promise<WorkspaceSlackChannelIntegrationModel> {
    const response = await this._client.request<
      WorkspaceSlackChannelIntegrationQuery,
      WorkspaceSlackChannelIntegrationQueryVariables
    ...
    return new WorkspaceSlackChannelIntegrationModel(
      this._client,
      response.workspaceSlackChannelIntegration,
    );
  }

  async workspaceSlackChannelIntegrations(
    variables: WorkspaceSlackChannelIntegrationsQueryVariables,
  ): Promise<PlainConnection<WorkspaceSlackChannelIntegrationModel>> {
    const response = await this._client.request<
      WorkspaceSlackChannelIntegrationsQuery,
      WorkspaceSlackChannelIntegrationsQueryVariables
    ...
    return new PlainConnection<WorkspaceSlackChannelIntegrationModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.workspaceSlackChannelIntegrations({
          ...variables,
          ...cursor,
        } as WorkspaceSlackChannelIntegrationsQueryVariables),
    });
  }

  async workspaceSlackInstallationInfo(
    variables: WorkspaceSlackInstallationInfoQueryVariables,
  ): Promise<WorkspaceSlackInstallationInfoQuery["workspaceSlackInstallationInfo"]> {
    const response = await this._client.request<
      WorkspaceSlackInstallationInfoQuery,
      WorkspaceSlackInstallationInfoQueryVariables
  ...
  async workspaceSlackIntegration(
    variables: WorkspaceSlackIntegrationQueryVariables,
  ): Promise<WorkspaceSlackIntegrationModel> {
    const response = await this._client.request<
      WorkspaceSlackIntegrationQuery,
      WorkspaceSlackIntegrationQueryVariables
  ...
  async workspaceSlackIntegrations(
    variables: WorkspaceSlackIntegrationsQueryVariables,
  ): Promise<PlainConnection<WorkspaceSlackIntegrationModel>> {
    const response = await this._client.request<
      WorkspaceSlackIntegrationsQuery,
      WorkspaceSlackIntegrationsQueryVariables
    ...
    return new PlainConnection<WorkspaceSlackIntegrationModel>({
      ...
      pageInfo: conn.pageInfo,
      fetch: (cursor) =>
        this.workspaceSlackIntegrations({
          ...variables,
          ...cursor,
        } as WorkspaceSlackIntegrationsQueryVariables),
    });
  }

  async acceptWorkspaceInvite(
    variables: AcceptWorkspaceInviteMutationVariables,
  ): Promise<AcceptWorkspaceInviteMutation["acceptWorkspaceInvite"]> {
    const response = await this._client.request<
      AcceptWorkspaceInviteMutation,
      AcceptWorkspaceInviteMutationVariables
  ...
  async addAdditionalAssignees(
    variables: AddAdditionalAssigneesMutationVariables,
  ): Promise<AddAdditionalAssigneesMutation["addAdditionalAssignees"]> {
    const response = await this._client.request<
      AddAdditionalAssigneesMutation,
      AddAdditionalAssigneesMutationVariables
  ...
  async addCustomerToCustomerGroups(
    variables: AddCustomerToCustomerGroupsMutationVariables,
  ): Promise<AddCustomerToCustomerGroupsMutation["addCustomerToCustomerGroups"]> {
    const response = await this._client.request<
      AddCustomerToCustomerGroupsMutation,
      AddCustomerToCustomerGroupsMutationVariables
  ...
  async addCustomerToTenants(
    variables: AddCustomerToTenantsMutationVariables,
  ): Promise<AddCustomerToTenantsMutation["addCustomerToTenants"]> {
    const response = await this._client.request<
      AddCustomerToTenantsMutation,
      AddCustomerToTenantsMutationVariables
  ...
  async addGeneratedReply(
    variables: AddGeneratedReplyMutationVariables,
  ): Promise<AddGeneratedReplyMutation["addGeneratedReply"]> {
    const response = await this._client.request<
      AddGeneratedReplyMutation,
      AddGeneratedReplyMutationVariables
  ...
  async addLabelsToUser(
    variables: AddLabelsToUserMutationVariables,
  ): Promise<AddLabelsToUserMutation["addLabelsToUser"]> {
    const response = await this._client.request<
      AddLabelsToUserMutation,
      AddLabelsToUserMutationVariables
  ...
  async addMembersToTier(
    variables: AddMembersToTierMutationVariables,
  ): Promise<AddMembersToTierMutation["addMembersToTier"]> {
    const response = await this._client.request<
      AddMembersToTierMutation,
      AddMembersToTierMutationVariables
  ...
  async addUserToActiveBillingRota(
    variables: AddUserToActiveBillingRotaMutationVariables,
  ): Promise<AddUserToActiveBillingRotaMutation["addUserToActiveBillingRota"]> {
    const response = await this._client.request<
      AddUserToActiveBillingRotaMutation,
      AddUserToActiveBillingRotaMutationVariables
  ...
  async addWorkspaceAlternateSupportEmailAddress(
    variables: AddWorkspaceAlternateSupportEmailAddressMutationVariables,
  ): Promise<
    AddWorkspaceAlternateSupportEmailAddressMutation["addWorkspaceAlternateSupportEmailAddress"]
  > {
    const response = await this._client.request<
      AddWorkspaceAlternateSupportEmailAddressMutation,
      AddWorkspaceAlternateSupportEmailAddressMutationVariables
  ...
  async archiveLabelType(
    variables: ArchiveLabelTypeMutationVariables,
  ): Promise<ArchiveLabelTypeMutation["archiveLabelType"]> {
    const response = await this._client.request<
      ArchiveLabelTypeMutation,
      ArchiveLabelTypeMutationVariables
  ...
  async assignRolesToUser(
    variables: AssignRolesToUserMutationVariables,
  ...
  async assignThread(
    variables: AssignThreadMutationVariables,
  ): Promise<AssignThreadMutation["assignThread"]> {
    const response = await this._client.request<
      AssignThreadMutation,
      AssignThreadMutationVariables
  ...
  async bulkJoinSlackChannels(
    variables: BulkJoinSlackChannelsMutationVariables,
  ): Promise<BulkJoinSlackChannelsMutation["bulkJoinSlackChannels"]> {
    const response = await this._client.request<
      BulkJoinSlackChannelsMutation,
      BulkJoinSlackChannelsMutationVariables
  ...
  async bulkUpsertThreadFields(
    variables: BulkUpsertThreadFieldsMutationVariables,
  ): Promise<BulkUpsertThreadFieldsMutation["bulkUpsertThreadFields"]> {
    const response = await this._client.request<
      BulkUpsertThreadFieldsMutation,
      BulkUpsertThreadFieldsMutationVariables
  ...
  async bulkUpsertWorkflowSteps(
    variables: BulkUpsertWorkflowStepsMutationVariables,
  ): Promise<BulkUpsertWorkflowStepsMutation["bulkUpsertWorkflowSteps"]> {
    const response = await this._client.request<
      BulkUpsertWorkflowStepsMutation,
      BulkUpsertWorkflowStepsMutationVariables
  ...
  async calculateRoleChangeCost(
    variables: CalculateRoleChangeCostMutationVariables,
  ): Promise<CalculateRoleChangeCostMutation["calculateRoleChangeCost"]> {
    const response = await this._client.request<
      CalculateRoleChangeCostMutation,
      CalculateRoleChangeCostMutationVariables
  ...
  async changeBillingPlan(
    variables: ChangeBillingPlanMutationVariables,
  ): Promise<ChangeBillingPlanMutation["changeBillingPlan"]> {
    const response = await this._client.request<
      ChangeBillingPlanMutation,
      ChangeBillingPlanMutationVariables
  ...
  async changeThreadCustomer(
    variables: ChangeThreadCustomerMutationVariables,
  ): Promise<ChangeThreadCustomerMutation["changeThreadCustomer"]> {
    const response = await this._client.request<
      ChangeThreadCustomerMutation,
      ChangeThreadCustomerMutationVariables
  ...
  async changeThreadPriority(
    variables: ChangeThreadPriorityMutationVariables,
  ): Promise<ChangeThreadPriorityMutation["changeThreadPriority"]> {
    const response = await this._client.request<
      ChangeThreadPriorityMutation,
      ChangeThreadPriorityMutationVariables
  ...
  ): Promise<ChangeUserStatusMutation["changeUserStatus"]> {
    const response = await this._client.request<
      ChangeUserStatusMutation,
      ChangeUserStatusMutationVariables
  ...
  async completeServiceAuthorization(
    variables: CompleteServiceAuthorizationMutationVariables,
  ): Promise<CompleteServiceAuthorizationMutation["completeServiceAuthorization"]> {
    const response = await this._client.request<
      CompleteServiceAuthorizationMutation,
      CompleteServiceAuthorizationMutationVariables
  ...
  async createAiFeatureFeedback(
    variables: CreateAiFeatureFeedbackMutationVariables,
  ): Promise<CreateAiFeatureFeedbackMutation["createAiFeatureFeedback"]> {
    const response = await this._client.request<
      CreateAiFeatureFeedbackMutation,
      CreateAiFeatureFeedbackMutationVariables
  ...
  async createAiFeedback(
    variables: CreateAiFeedbackMutationVariables,
  ): Promise<CreateAiFeedbackMutation["createAiFeedback"]> {
    const response = await this._client.request<
      CreateAiFeedbackMutation,
      CreateAiFeedbackMutationVariables
  ...
  async createAiToneRule(
    variables: CreateAiToneRuleMutationVariables,
  ): Promise<CreateAiToneRuleMutation["createAiToneRule"]> {
    const response = await this._client.request<
      CreateAiToneRuleMutation,
      CreateAiToneRuleMutationVariables
  ...
  ): Promise<CreateApiKeyMutation["createApiKey"]> {
    const response = await this._client.request<
      CreateApiKeyMutation,
      CreateApiKeyMutationVariables
  ...
  async createAttachmentDownloadUrl(
    variables: CreateAttachmentDownloadUrlMutationVariables,
  ): Promise<CreateAttachmentDownloadUrlMutation["createAttachmentDownloadUrl"]> {
    const response = await this._client.request<
      CreateAttachmentDownloadUrlMutation,
      CreateAttachmentDownloadUrlMutationVariables
  ...
  async createAttachmentUploadUrl(
    variables: CreateAttachmentUploadUrlMutationVariables,
  ): Promise<CreateAttachmentUploadUrlMutation["createAttachmentUploadUrl"]> {
    const response = await this._client.request<
      CreateAttachmentUploadUrlMutation,
      CreateAttachmentUploadUrlMutationVariables
  ...
  async createAutoresponder(
    variables: CreateAutoresponderMutationVariables,
  ): Promise<CreateAutoresponderMutation["createAutoresponder"]> {
    const response = await this._client.request<
      CreateAutoresponderMutation,
      CreateAutoresponderMutationVariables
  ...
  async createBillingPortalSession(): Promise<
    CreateBillingPortalSessionMutation["createBillingPortalSession"]
  > {
    const response = await this._client.request<
      CreateBillingPortalSessionMutation,
      Record<string, never>
  ...
  async createChatApp(
    variables: CreateChatAppMutationVariables,
  ): Promise<CreateChatAppMutation["createChatApp"]> {
    const response = await this._client.request<
      CreateChatAppMutation,
      CreateChatAppMutationVariables
  ...
  async createChatAppSecret(
    variables: CreateChatAppSecretMutationVariables,
  ): Promise<CreateChatAppSecretMutation["createChatAppSecret"]> {
    const response = await this._client.request<
      CreateChatAppSecretMutation,
      CreateChatAppSecretMutationVariables
  ...
  async createCustomRole(
    variables: CreateCustomRoleMutationVariables,
  ): Promise<CreateCustomRoleMutation["createCustomRole"]> {
    const response = await this._client.request<
      CreateCustomRoleMutation,
      CreateCustomRoleMutationVariables
  ...
  async createCustomerCardConfig(
    variables: CreateCustomerCardConfigMutationVariables,
  ): Promise<CreateCustomerCardConfigMutation["createCustomerCardConfig"]> {
    const response = await this._client.request<
      CreateCustomerCardConfigMutation,
      CreateCustomerCardConfigMutationVariables
  ...
  async createCustomerEvent(
    variables: CreateCustomerEventMutationVariables,
  ): Promise<CreateCustomerEventMutation["createCustomerEvent"]> {
    const response = await this._client.request<
      CreateCustomerEventMutation,
      CreateCustomerEventMutationVariables
  ...
  async createCustomerGroup(
    variables: CreateCustomerGroupMutationVariables,
  ): Promise<CreateCustomerGroupMutation["createCustomerGroup"]> {
    const response = await this._client.request<
      CreateCustomerGroupMutation,
      CreateCustomerGroupMutationVariables
  ...
  async createCustomerSurvey(
    variables: CreateCustomerSurveyMutationVariables,
  ): Promise<CreateCustomerSurveyMutation["createCustomerSurvey"]> {
    const response = await this._client.request<
      CreateCustomerSurveyMutation,
      CreateCustomerSurveyMutationVariables
  ...
  async createEmailPreviewUrl(
    variables: CreateEmailPreviewUrlMutationVariables,
  ): Promise<CreateEmailPreviewUrlMutation["createEmailPreviewUrl"]> {
    const response = await this._client.request<
      CreateEmailPreviewUrlMutation,
      CreateEmailPreviewUrlMutationVariables
  ...
  async createEscalationPath(
    variables: CreateEscalationPathMutationVariables,
  ): Promise<CreateEscalationPathMutation["createEscalationPath"]> {
    const response = await this._client.request<
      CreateEscalationPathMutation,
      CreateEscalationPathMutationVariables
  ...
  async createGithubUserAuthIntegration(
    variables: CreateGithubUserAuthIntegrationMutationVariables,
  ): Promise<CreateGithubUserAuthIntegrationMutation["createGithubUserAuthIntegration"]> {
    const response = await this._client.request<
      CreateGithubUserAuthIntegrationMutation,
      CreateGithubUserAuthIntegrationMutationVariables
  ...
  async createHelpCenter(
    variables: CreateHelpCenterMutationVariables,
  ): Promise<CreateHelpCenterMutation["createHelpCenter"]> {
    const response = await this._client.request<
      CreateHelpCenterMutation,
      CreateHelpCenterMutationVariables
  ...
  async createHelpCenterArticleGroup(
    variables: CreateHelpCenterArticleGroupMutationVariables,
  ): Promise<CreateHelpCenterArticleGroupMutation["createHelpCenterArticleGroup"]> {
    const response = await this._client.request<
      CreateHelpCenterArticleGroupMutation,
      CreateHelpCenterArticleGroupMutationVariables
  ...
  async createHyperlineBillingPortalSession(): Promise<
    CreateHyperlineBillingPortalSessionMutation["createHyperlineBillingPortalSession"]
  > {
    const response = await this._client.request<
      CreateHyperlineBillingPortalSessionMutation,
      Record<string, never>
  ...
  async createHyperlineCheckoutSession(
    variables: CreateHyperlineCheckoutSessionMutationVariables,
  ): Promise<CreateHyperlineCheckoutSessionMutation["createHyperlineCheckoutSession"]> {
    const response = await this._client.request<
      CreateHyperlineCheckoutSessionMutation,
      CreateHyperlineCheckoutSessionMutationVariables
  ...
  async createHyperlineComponentsAuthToken(): Promise<
    CreateHyperlineComponentsAuthTokenMutation["createHyperlineComponentsAuthToken"]
  > {
    const response = await this._client.request<
      CreateHyperlineComponentsAuthTokenMutation,
      Record<string, never>
  ...
  async createIndexedDocument(
    variables: CreateIndexedDocumentMutationVariables,
  ): Promise<CreateIndexedDocumentMutation["createIndexedDocument"]> {
    const response = await this._client.request<
      CreateIndexedDocumentMutation,
      CreateIndexedDocumentMutationVariables
  ...
  async createIssueTrackerIssue(
    variables: CreateIssueTrackerIssueMutationVariables,
  ): Promise<CreateIssueTrackerIssueMutation["createIssueTrackerIssue"]> {
    const response = await this._client.request<
      CreateIssueTrackerIssueMutation,
      CreateIssueTrackerIssueMutationVariables
  ...
  async createKnowledgeSource(
    variables: CreateKnowledgeSourceMutationVariables,
  ): Promise<CreateKnowledgeSourceMutation["createKnowledgeSource"]> {
    const response = await this._client.request<
      CreateKnowledgeSourceMutation,
      CreateKnowledgeSourceMutationVariables
  ...
  async createLabelType(
    variables: CreateLabelTypeMutationVariables,
  ): Promise<CreateLabelTypeMutation["createLabelType"]> {
    const response = await this._client.request<
      CreateLabelTypeMutation,
      CreateLabelTypeMutationVariables
  ...
  async createMachineUser(
    variables: CreateMachineUserMutationVariables,
  ): Promise<CreateMachineUserMutation["createMachineUser"]> {
    const response = await this._client.request<
      CreateMachineUserMutation,
      CreateMachineUserMutationVariables
  ...
  async createMyFavoritePage(
    variables: CreateMyFavoritePageMutationVariables,
  ): Promise<CreateMyFavoritePageMutation["createMyFavoritePage"]> {
    const response = await this._client.request<
      CreateMyFavoritePageMutation,
      CreateMyFavoritePageMutationVariables
  ...
  async createMyLinearIntegration(
    variables: CreateMyLinearIntegrationMutationVariables,
  ): Promise<CreateMyLinearIntegrationMutation["createMyLinearIntegration"]> {
    const response = await this._client.request<
      CreateMyLinearIntegrationMutation,
      CreateMyLinearIntegrationMutationVariables
  ...
  async createMyMSTeamsIntegration(
    variables: CreateMyMsTeamsIntegrationMutationVariables,
  ): Promise<CreateMyMsTeamsIntegrationMutation["createMyMSTeamsIntegration"]> {
    const response = await this._client.request<
      CreateMyMsTeamsIntegrationMutation,
      CreateMyMsTeamsIntegrationMutationVariables
  ...
  async createMySlackIntegration(
    variables: CreateMySlackIntegrationMutationVariables,
  ): Promise<CreateMySlackIntegrationMutation["createMySlackIntegration"]> {
    const response = await this._client.request<
      CreateMySlackIntegrationMutation,
      CreateMySlackIntegrationMutationVariables
  ...
  ): Promise<CreateNoteMutation["createNote"]> {
  ...
  async createSavedThreadsView(
    variables: CreateSavedThreadsViewMutationVariables,
  ): Promise<CreateSavedThreadsViewMutation["createSavedThreadsView"]> {
    const response = await this._client.request<
      CreateSavedThreadsViewMutation,
      CreateSavedThreadsViewMutationVariables
  ...
  async createServiceLevelAgreement(
    variables: CreateServiceLevelAgreementMutationVariables,
  ): Promise<CreateServiceLevelAgreementMutation["createServiceLevelAgreement"]> {
    const response = await this._client.request<
      CreateServiceLevelAgreementMutation,
      CreateServiceLevelAgreementMutationVariables
  ...
  ): Promise<CreateSnippetMutation["createSnippet"]> {
    const response = await this._client.request<
      CreateSnippetMutation,
      CreateSnippetMutationVariables
  ...
  ): Promise<CreateThreadMutation["createThread"]> {
    const response = await this._client.request<
      CreateThreadMutation,
      CreateThreadMutationVariables
  ...
  async createThreadChannelAssociation(
    variables: CreateThreadChannelAssociationMutationVariables,
  ): Promise<CreateThreadChannelAssociationMutation["createThreadChannelAssociation"]> {
    const response = await this._client.request<
      CreateThreadChannelAssociationMutation,
      CreateThreadChannelAssociationMutationVariables
  ...
  async createThreadDiscussion(
    variables: CreateThreadDiscussionMutationVariables,
  ): Promise<CreateThreadDiscussionMutation["createThreadDiscussion"]> {
    const response = await this._client.request<
      CreateThreadDiscussionMutation,
      CreateThreadDiscussionMutationVariables
  ...
  async createThreadEvent(
    variables: CreateThreadEventMutationVariables,
  ): Promise<CreateThreadEventMutation["createThreadEvent"]> {
    const response = await this._client.request<
      CreateThreadEventMutation,
      CreateThreadEventMutationVariables
  ...
  async createThreadFieldSchema(
    variables: CreateThreadFieldSchemaMutationVariables,
  ): Promise<CreateThreadFieldSchemaMutation["createThreadFieldSchema"]> {
    const response = await this._client.request<
      CreateThreadFieldSchemaMutation,
      CreateThreadFieldSchemaMutationVariables
  ...
  async createThreadLink(
    variables: CreateThreadLinkMutationVariables,
  ): Promise<CreateThreadLinkMutation["createThreadLink"]> {
    const response = await this._client.request<
      CreateThreadLinkMutation,
      CreateThreadLinkMutationVariables
  ...
  ): Promise<CreateTierMutation["createTier"]> {
  ...
  ): Promise<CreateUserAccountMutation["createUserAccount"]> {
    const response = await this._client.request<
      CreateUserAccountMutation,
      CreateUserAccountMutationVariables
  ...
  async createUserAuthDiscordChannelIntegration(
    variables: CreateUserAuthDiscordChannelIntegrationMutationVariables,
  ): Promise<
    CreateUserAuthDiscordChannelIntegrationMutation["createUserAuthDiscordChannelIntegration"]
  > {
    const response = await this._client.request<
      CreateUserAuthDiscordChannelIntegrationMutation,
      CreateUserAuthDiscordChannelIntegrationMutationVariables
  ...
  async createUserAuthSlackIntegration(
    variables: CreateUserAuthSlackIntegrationMutationVariables,
  ): Promise<CreateUserAuthSlackIntegrationMutation["createUserAuthSlackIntegration"]> {
    const response = await this._client.request<
      CreateUserAuthSlackIntegrationMutation,
      CreateUserAuthSlackIntegrationMutationVariables
  ...
  ): Promise<CreateWebhookTargetMutation["createWebhookTarget"]> {
    const response = await this._client.request<
      CreateWebhookTargetMutation,
      CreateWebhookTargetMutationVariables
  ...
  ): Promise<CreateWorkflowMutation["createWorkflow"]> {
    const response = await this._client.request<
      CreateWorkflowMutation,
      CreateWorkflowMutationVariables
  ...
  async createWorkflowRule(
    variables: CreateWorkflowRuleMutationVariables,
  ): Promise<CreateWorkflowRuleMutation["createWorkflowRule"]> {
    const response = await this._client.request<
      CreateWorkflowRuleMutation,
      CreateWorkflowRuleMutationVariables
  ...
  async createWorkflowStep(
    variables: CreateWorkflowStepMutationVariables,
  ): Promise<CreateWorkflowStepMutation["createWorkflowStep"]> {
    const response = await this._client.request<
      CreateWorkflowStepMutation,
      CreateWorkflowStepMutationVariables
  ...
  ): Promise<CreateWorkspaceMutation["createWorkspace"]> {
    const response = await this._client.request<
      CreateWorkspaceMutation,
      CreateWorkspaceMutationVariables
  ...
  async createWorkspaceCursorIntegration(
    variables: CreateWorkspaceCursorIntegrationMutationVariables,
  ): Promise<CreateWorkspaceCursorIntegrationMutation["createWorkspaceCursorIntegration"]> {
    const response = await this._client.request<
      CreateWorkspaceCursorIntegrationMutation,
      CreateWorkspaceCursorIntegrationMutationVariables
  ...
  async createWorkspaceDiscordChannelIntegration(
    variables: CreateWorkspaceDiscordChannelIntegrationMutationVariables,
  ): Promise<
    CreateWorkspaceDiscordChannelIntegrationMutation["createWorkspaceDiscordChannelIntegration"]
  > {
    const response = await this._client.request<
      CreateWorkspaceDiscordChannelIntegrationMutation,
      CreateWorkspaceDiscordChannelIntegrationMutationVariables
  ...
  async createWorkspaceDiscordIntegration(
    variables: CreateWorkspaceDiscordIntegrationMutationVariables,
  ): Promise<CreateWorkspaceDiscordIntegrationMutation["createWorkspaceDiscordIntegration"]> {
    const response = await this._client.request<
      CreateWorkspaceDiscordIntegrationMutation,
      CreateWorkspaceDiscordIntegrationMutationVariables
  ...
  async createWorkspaceEmailDomainSettings(
    variables: CreateWorkspaceEmailDomainSettingsMutationVariables,
  ): Promise<CreateWorkspaceEmailDomainSettingsMutation["createWorkspaceEmailDomainSettings"]> {
    const response = await this._client.request<
      CreateWorkspaceEmailDomainSettingsMutation,
      CreateWorkspaceEmailDomainSettingsMutationVariables
  ...
  async createWorkspaceFileUploadUrl(
    variables: CreateWorkspaceFileUploadUrlMutationVariables,
  ): Promise<CreateWorkspaceFileUploadUrlMutation["createWorkspaceFileUploadUrl"]> {
    const response = await this._client.request<
      CreateWorkspaceFileUploadUrlMutation,
      CreateWorkspaceFileUploadUrlMutationVariables
  ...
  async createWorkspaceMSTeamsIntegration(
    variables: CreateWorkspaceMsTeamsIntegrationMutationVariables,
  ): Promise<CreateWorkspaceMsTeamsIntegrationMutation["createWorkspaceMSTeamsIntegration"]> {
    const response = await this._client.request<
      CreateWorkspaceMsTeamsIntegrationMutation,
      CreateWorkspaceMsTeamsIntegrationMutationVariables
  ...
  async createWorkspaceSlackChannelIntegration(
    variables: CreateWorkspaceSlackChannelIntegrationMutationVariables,
  ): Promise<
    CreateWorkspaceSlackChannelIntegrationMutation["createWorkspaceSlackChannelIntegration"]
  > {
    const response = await this._client.request<
      CreateWorkspaceSlackChannelIntegrationMutation,
      CreateWorkspaceSlackChannelIntegrationMutationVariables
  ...
  async createWorkspaceSlackIntegration(
    variables: CreateWorkspaceSlackIntegrationMutationVariables,
  ): Promise<CreateWorkspaceSlackIntegrationMutation["createWorkspaceSlackIntegration"]> {
    const response = await this._client.request<
      CreateWorkspaceSlackIntegrationMutation,
      CreateWorkspaceSlackIntegrationMutationVariables
  ...
  async deleteAiToneRules(
    variables: DeleteAiToneRulesMutationVariables,
  ): Promise<DeleteAiToneRulesMutation["deleteAiToneRules"]> {
    const response = await this._client.request<
      DeleteAiToneRulesMutation,
      DeleteAiToneRulesMutationVariables
  ...
  ): Promise<DeleteApiKeyMutation["deleteApiKey"]> {
    const response = await this._client.request<
      DeleteApiKeyMutation,
      DeleteApiKeyMutationVariables
  ...
  async deleteAutoresponder(
    variables: DeleteAutoresponderMutationVariables,
  ): Promise<DeleteAutoresponderMutation["deleteAutoresponder"]> {
    const response = await this._client.request<
      DeleteAutoresponderMutation,
      DeleteAutoresponderMutationVariables
  ...
  async deleteChatApp(
    variables: DeleteChatAppMutationVariables,
  ): Promise<DeleteChatAppMutation["deleteChatApp"]> {
    const response = await this._client.request<
      DeleteChatAppMutation,
      DeleteChatAppMutationVariables
  ...
  async deleteChatAppSecret(
    variables: DeleteChatAppSecretMutationVariables,
  ): Promise<DeleteChatAppSecretMutation["deleteChatAppSecret"]> {
    const response = await this._client.request<
      DeleteChatAppSecretMutation,
      DeleteChatAppSecretMutationVariables
  ...
  ): Promise<DeleteCompanyMutation["deleteCompany"]> {
    const response = await this._client.request<
      DeleteCompanyMutation,
      DeleteCompanyMutationVariables
  ...
  async deleteCustomRole(
    variables: DeleteCustomRoleMutationVariables,
  ): Promise<DeleteCustomRoleMutation["deleteCustomRole"]> {
    const response = await this._client.request<
      DeleteCustomRoleMutation,
      DeleteCustomRoleMutationVariables
  ...
  ): Promise<DeleteCustomerMutation["deleteCustomer"]> {
    const response = await this._client.request<
      DeleteCustomerMutation,
      DeleteCustomerMutationVariables
  ...
  async deleteCustomerCardConfig(
    variables: DeleteCustomerCardConfigMutationVariables,
  ): Promise<DeleteCustomerCardConfigMutation["deleteCustomerCardConfig"]> {
    const response = await this._client.request<
      DeleteCustomerCardConfigMutation,
      DeleteCustomerCardConfigMutationVariables
  ...
  async deleteCustomerGroup(
    variables: DeleteCustomerGroupMutationVariables,
  ): Promise<DeleteCustomerGroupMutation["deleteCustomerGroup"]> {
    const response = await this._client.request<
      DeleteCustomerGroupMutation,
      DeleteCustomerGroupMutationVariables
  ...
  async deleteCustomerSurvey(
    variables: DeleteCustomerSurveyMutationVariables,
  ): Promise<DeleteCustomerSurveyMutation["deleteCustomerSurvey"]> {
    const response = await this._client.request<
      DeleteCustomerSurveyMutation,
      DeleteCustomerSurveyMutationVariables
  ...
  async deleteEscalationPath(
    variables: DeleteEscalationPathMutationVariables,
  ): Promise<DeleteEscalationPathMutation["deleteEscalationPath"]> {
    const response = await this._client.request<
      DeleteEscalationPathMutation,
      DeleteEscalationPathMutationVariables
  ...
  async deleteGithubUserAuthIntegration(): Promise<
    DeleteGithubUserAuthIntegrationMutation["deleteGithubUserAuthIntegration"]
  > {
    const response = await this._client.request<
      DeleteGithubUserAuthIntegrationMutation,
      Record<string, never>
  ...
  async deleteHelpCenter(
    variables: DeleteHelpCenterMutationVariables,
  ): Promise<DeleteHelpCenterMutation["deleteHelpCenter"]> {
    const response = await this._client.request<
      DeleteHelpCenterMutation,
      DeleteHelpCenterMutationVariables
  ...
  async deleteHelpCenterArticle(
    variables: DeleteHelpCenterArticleMutationVariables,
  ): Promise<DeleteHelpCenterArticleMutation["deleteHelpCenterArticle"]> {
    const response = await this._client.request<
      DeleteHelpCenterArticleMutation,
      DeleteHelpCenterArticleMutationVariables
  ...
  async deleteHelpCenterArticleGroup(
    variables: DeleteHelpCenterArticleGroupMutationVariables,
  ): Promise<DeleteHelpCenterArticleGroupMutation["deleteHelpCenterArticleGroup"]> {
    const response = await this._client.request<
      DeleteHelpCenterArticleGroupMutation,
      DeleteHelpCenterArticleGroupMutationVariables
  ...
  async deleteKnowledgeSource(
    variables: DeleteKnowledgeSourceMutationVariables,
  ): Promise<DeleteKnowledgeSourceMutation["deleteKnowledgeSource"]> {
    const response = await this._client.request<
      DeleteKnowledgeSourceMutation,
      DeleteKnowledgeSourceMutationVariables
  ...
  async deleteMachineUser(
    variables: DeleteMachineUserMutationVariables,
  ): Promise<DeleteMachineUserMutation["deleteMachineUser"]> {
    const response = await this._client.request<
      DeleteMachineUserMutation,
      DeleteMachineUserMutationVariables
  ...
  async deleteMyFavoritePage(
    variables: DeleteMyFavoritePageMutationVariables,
  ): Promise<DeleteMyFavoritePageMutation["deleteMyFavoritePage"]> {
    const response = await this._client.request<
      DeleteMyFavoritePageMutation,
      DeleteMyFavoritePageMutationVariables
  ...
  async deleteMyLinearIntegration(): Promise<
    DeleteMyLinearIntegrationMutation["deleteMyLinearIntegration"]
  > {
    const response = await this._client.request<
      DeleteMyLinearIntegrationMutation,
      Record<string, never>
  ...
  async deleteMyMSTeamsIntegration(): Promise<
    DeleteMyMsTeamsIntegrationMutation["deleteMyMSTeamsIntegration"]
  > {
    const response = await this._client.request<
      DeleteMyMsTeamsIntegrationMutation,
      Record<string, never>
  ...
  async deleteMyServiceAuthorization(
    variables: DeleteMyServiceAuthorizationMutationVariables,
  ): Promise<DeleteMyServiceAuthorizationMutation["deleteMyServiceAuthorization"]> {
    const response = await this._client.request<
      DeleteMyServiceAuthorizationMutation,
      DeleteMyServiceAuthorizationMutationVariables
  ...
  async deleteMySlackIntegration(): Promise<
    DeleteMySlackIntegrationMutation["deleteMySlackIntegration"]
  > {
    const response = await this._client.request<
      DeleteMySlackIntegrationMutation,
      Record<string, never>
  ...
  ): Promise<DeleteNoteMutation["deleteNote"]> {
  ...
  async deleteSavedThreadsView(
    variables: DeleteSavedThreadsViewMutationVariables,
  ): Promise<DeleteSavedThreadsViewMutation["deleteSavedThreadsView"]> {
    const response = await this._client.request<
      DeleteSavedThreadsViewMutation,
      DeleteSavedThreadsViewMutationVariables
  ...
  async deleteServiceAuthorization(
    variables: DeleteServiceAuthorizationMutationVariables,
  ): Promise<DeleteServiceAuthorizationMutation["deleteServiceAuthorization"]> {
    const response = await this._client.request<
      DeleteServiceAuthorizationMutation,
      DeleteServiceAuthorizationMutationVariables
  ...
  async deleteServiceLevelAgreement(
    variables: DeleteServiceLevelAgreementMutationVariables,
  ): Promise<DeleteServiceLevelAgreementMutation["deleteServiceLevelAgreement"]> {
    const response = await this._client.request<
      DeleteServiceLevelAgreementMutation,
      DeleteServiceLevelAgreementMutationVariables
  ...
  async deleteSnippet(
    variables: DeleteSnippetMutationVariables,
  ): Promise<DeleteSnippetMutation["deleteSnippet"]> {
    const response = await this._client.request<
      DeleteSnippetMutation,
      DeleteSnippetMutationVariables
  ...
  ): Promise<DeleteTaskMutation["deleteTask"]> {
  ...
  ): Promise<DeleteTenantMutation["deleteTenant"]> {
    const response = await this._client.request<
      DeleteTenantMutation,
      DeleteTenantMutationVariables
  ...
  async deleteTenantField(
    variables: DeleteTenantFieldMutationVariables,
  ): Promise<DeleteTenantFieldMutation["deleteTenantField"]> {
    const response = await this._client.request<
      DeleteTenantFieldMutation,
      DeleteTenantFieldMutationVariables
  ...
  async deleteTenantFieldSchema(
    variables: DeleteTenantFieldSchemaMutationVariables,
  ): Promise<DeleteTenantFieldSchemaMutation["deleteTenantFieldSchema"]> {
    const response = await this._client.request<
      DeleteTenantFieldSchemaMutation,
      DeleteTenantFieldSchemaMutationVariables
  ...
  ): Promise<DeleteThreadMutation["deleteThread"]> {
    const response = await this._client.request<
      DeleteThreadMutation,
      DeleteThreadMutationVariables
  ...
  async deleteThreadChannelAssociation(
    variables: DeleteThreadChannelAssociationMutationVariables,
  ): Promise<DeleteThreadChannelAssociationMutation["deleteThreadChannelAssociation"]> {
    const response = await this._client.request<
      DeleteThreadChannelAssociationMutation,
      DeleteThreadChannelAssociationMutationVariables
  ...
  async deleteThreadField(
    variables: DeleteThreadFieldMutationVariables,
  ): Promise<DeleteThreadFieldMutation["deleteThreadField"]> {
    const response = await this._client.request<
      DeleteThreadFieldMutation,
      DeleteThreadFieldMutationVariables
  ...
  async deleteThreadFieldSchema(
    variables: DeleteThreadFieldSchemaMutationVariables,
  ): Promise<DeleteThreadFieldSchemaMutation["deleteThreadFieldSchema"]> {
    const response = await this._client.request<
      DeleteThreadFieldSchemaMutation,
      DeleteThreadFieldSchemaMutationVariables
  ...
  async deleteThreadLink(
    variables: DeleteThreadLinkMutationVariables,
  ): Promise<DeleteThreadLinkMutation["deleteThreadLink"]> {
    const response = await this._client.request<
      DeleteThreadLinkMutation,
      DeleteThreadLinkMutationVariables
  ...
  async deleteTier(
    variables: DeleteTierMutationVariables,
  ): Promise<DeleteTierMutation["deleteTier"]> {
  ...
  async deleteUserAuthDiscordChannelIntegration(
    variables: DeleteUserAuthDiscordChannelIntegrationMutationVariables,
  ): Promise<
    DeleteUserAuthDiscordChannelIntegrationMutation["deleteUserAuthDiscordChannelIntegration"]
  > {
    const response = await this._client.request<
      DeleteUserAuthDiscordChannelIntegrationMutation,
      DeleteUserAuthDiscordChannelIntegrationMutationVariables
  ...
  async deleteUserAuthSlackIntegration(
    variables: DeleteUserAuthSlackIntegrationMutationVariables,
  ): Promise<DeleteUserAuthSlackIntegrationMutation["deleteUserAuthSlackIntegration"]> {
    const response = await this._client.request<
      DeleteUserAuthSlackIntegrationMutation,
      DeleteUserAuthSlackIntegrationMutationVariables
  ...
  ): Promise<DeleteWebhookTargetMutation["deleteWebhookTarget"]> {
    const response = await this._client.request<
      DeleteWebhookTargetMutation,
      DeleteWebhookTargetMutationVariables
  ...
  ): Promise<DeleteWorkflowMutation["deleteWorkflow"]> {
    const response = await this._client.request<
      DeleteWorkflowMutation,
      DeleteWorkflowMutationVariables
  ...
  async deleteWorkflowRule(
    variables: DeleteWorkflowRuleMutationVariables,
  ): Promise<DeleteWorkflowRuleMutation["deleteWorkflowRule"]> {
    const response = await this._client.request<
      DeleteWorkflowRuleMutation,
      DeleteWorkflowRuleMutationVariables
  ...
  async deleteWorkflowStep(
    variables: DeleteWorkflowStepMutationVariables,
  ): Promise<DeleteWorkflowStepMutation["deleteWorkflowStep"]> {
    const response = await this._client.request<
      DeleteWorkflowStepMutation,
      DeleteWorkflowStepMutationVariables
  ...
  async deleteWorkspaceCursorIntegration(
    variables: DeleteWorkspaceCursorIntegrationMutationVariables,
  ): Promise<DeleteWorkspaceCursorIntegrationMutation["deleteWorkspaceCursorIntegration"]> {
    const response = await this._client.request<
      DeleteWorkspaceCursorIntegrationMutation,
      DeleteWorkspaceCursorIntegrationMutationVariables
  ...
  async deleteWorkspaceDiscordChannelIntegration(
    variables: DeleteWorkspaceDiscordChannelIntegrationMutationVariables,
  ): Promise<
    DeleteWorkspaceDiscordChannelIntegrationMutation["deleteWorkspaceDiscordChannelIntegration"]
  > {
    const response = await this._client.request<
      DeleteWorkspaceDiscordChannelIntegrationMutation,
      DeleteWorkspaceDiscordChannelIntegrationMutationVariables
  ...
  async deleteWorkspaceDiscordIntegration(
    variables: DeleteWorkspaceDiscordIntegrationMutationVariables,
  ): Promise<DeleteWorkspaceDiscordIntegrationMutation["deleteWorkspaceDiscordIntegration"]> {
    const response = await this._client.request<
      DeleteWorkspaceDiscordIntegrationMutation,
      DeleteWorkspaceDiscordIntegrationMutationVariables
  ...
  async deleteWorkspaceEmailDomainSettings(): Promise<
    DeleteWorkspaceEmailDomainSettingsMutation["deleteWorkspaceEmailDomainSettings"]
  > {
    const response = await this._client.request<
      DeleteWorkspaceEmailDomainSettingsMutation,
      Record<string, never>
  ...
  async deleteWorkspaceFile(
    variables: DeleteWorkspaceFileMutationVariables,
  ): Promise<DeleteWorkspaceFileMutation["deleteWorkspaceFile"]> {
    const response = await this._client.request<
      DeleteWorkspaceFileMutation,
      DeleteWorkspaceFileMutationVariables
  ...
  async deleteWorkspaceInvite(
    variables: DeleteWorkspaceInviteMutationVariables,
  ): Promise<DeleteWorkspaceInviteMutation["deleteWorkspaceInvite"]> {
    const response = await this._client.request<
      DeleteWorkspaceInviteMutation,
      DeleteWorkspaceInviteMutationVariables
  ...
  async deleteWorkspaceMSTeamsIntegration(
    variables: DeleteWorkspaceMsTeamsIntegrationMutationVariables,
  ): Promise<DeleteWorkspaceMsTeamsIntegrationMutation["deleteWorkspaceMSTeamsIntegration"]> {
    const response = await this._client.request<
      DeleteWorkspaceMsTeamsIntegrationMutation,
      DeleteWorkspaceMsTeamsIntegrationMutationVariables
  ...
  async deleteWorkspaceSlackChannelIntegration(
    variables: DeleteWorkspaceSlackChannelIntegrationMutationVariables,
  ): Promise<
    DeleteWorkspaceSlackChannelIntegrationMutation["deleteWorkspaceSlackChannelIntegration"]
  > {
    const response = await this._client.request<
      DeleteWorkspaceSlackChannelIntegrationMutation,
      DeleteWorkspaceSlackChannelIntegrationMutationVariables
  ...
  async deleteWorkspaceSlackIntegration(
    variables: DeleteWorkspaceSlackIntegrationMutationVariables,
  ): Promise<DeleteWorkspaceSlackIntegrationMutation["deleteWorkspaceSlackIntegration"]> {
    const response = await this._client.request<
      DeleteWorkspaceSlackIntegrationMutation,
      DeleteWorkspaceSlackIntegrationMutationVariables
  ...
  async escalateThread(
    variables: EscalateThreadMutationVariables,
  ): Promise<EscalateThreadMutation["escalateThread"]> {
    const response = await this._client.request<
      EscalateThreadMutation,
      EscalateThreadMutationVariables
  ...
  async forkThread(
    variables: ForkThreadMutationVariables,
  ): Promise<ForkThreadMutation["forkThread"]> {
  ...
  async generateAiToneRulesFromDescription(
    variables: GenerateAiToneRulesFromDescriptionMutationVariables,
  ): Promise<GenerateAiToneRulesFromDescriptionMutation["generateAiToneRulesFromDescription"]> {
    const response = await this._client.request<
      GenerateAiToneRulesFromDescriptionMutation,
      GenerateAiToneRulesFromDescriptionMutationVariables
  ...
  async generateHelpCenterArticle(
    variables: GenerateHelpCenterArticleMutationVariables,
  ): Promise<GenerateHelpCenterArticleMutation["generateHelpCenterArticle"]> {
    const response = await this._client.request<
      GenerateHelpCenterArticleMutation,
      GenerateHelpCenterArticleMutationVariables
  ...
  async inviteUserToWorkspace(
    variables: InviteUserToWorkspaceMutationVariables,
  ): Promise<InviteUserToWorkspaceMutation["inviteUserToWorkspace"]> {
    const response = await this._client.request<
      InviteUserToWorkspaceMutation,
      InviteUserToWorkspaceMutationVariables
  ...
  async lockThread(
    variables: LockThreadMutationVariables,
  ): Promise<LockThreadMutation["lockThread"]> {
  ...
  async markCustomerAsSpam(
    variables: MarkCustomerAsSpamMutationVariables,
  ): Promise<MarkCustomerAsSpamMutation["markCustomerAsSpam"]> {
    const response = await this._client.request<
      MarkCustomerAsSpamMutation,
      MarkCustomerAsSpamMutationVariables
  ...
  async markThreadAsDone(
    variables: MarkThreadAsDoneMutationVariables,
  ): Promise<MarkThreadAsDoneMutation["markThreadAsDone"]> {
    const response = await this._client.request<
      MarkThreadAsDoneMutation,
      MarkThreadAsDoneMutationVariables
  ...
  async markThreadAsTodo(
    variables: MarkThreadAsTodoMutationVariables,
  ): Promise<MarkThreadAsTodoMutation["markThreadAsTodo"]> {
    const response = await this._client.request<
      MarkThreadAsTodoMutation,
      MarkThreadAsTodoMutationVariables
  ...
  async markThreadDiscussionAsResolved(
    variables: MarkThreadDiscussionAsResolvedMutationVariables,
  ): Promise<MarkThreadDiscussionAsResolvedMutation["markThreadDiscussionAsResolved"]> {
    const response = await this._client.request<
      MarkThreadDiscussionAsResolvedMutation,
      MarkThreadDiscussionAsResolvedMutationVariables
  ...
  async moveLabelType(
    variables: MoveLabelTypeMutationVariables,
  ): Promise<MoveLabelTypeMutation["moveLabelType"]> {
    const response = await this._client.request<
      MoveLabelTypeMutation,
      MoveLabelTypeMutationVariables
  ...
  async previewBillingPlanChange(
    variables: PreviewBillingPlanChangeMutationVariables,
  ): Promise<PreviewBillingPlanChangeMutation["previewBillingPlanChange"]> {
    const response = await this._client.request<
      PreviewBillingPlanChangeMutation,
      PreviewBillingPlanChangeMutationVariables
  ...
  async refreshConnectedDiscordChannels(
    variables: RefreshConnectedDiscordChannelsMutationVariables,
  ): Promise<RefreshConnectedDiscordChannelsMutation["refreshConnectedDiscordChannels"]> {
    const response = await this._client.request<
      RefreshConnectedDiscordChannelsMutation,
      RefreshConnectedDiscordChannelsMutationVariables
  ...
  async refreshWorkspaceSlackChannelIntegration(
    variables: RefreshWorkspaceSlackChannelIntegrationMutationVariables,
  ): Promise<
    RefreshWorkspaceSlackChannelIntegrationMutation["refreshWorkspaceSlackChannelIntegration"]
  > {
    const response = await this._client.request<
      RefreshWorkspaceSlackChannelIntegrationMutation,
      RefreshWorkspaceSlackChannelIntegrationMutationVariables
  ...
  async regenerateWorkspaceHmac(): Promise<
    RegenerateWorkspaceHmacMutation["regenerateWorkspaceHmac"]
  > {
    const response = await this._client.request<
      RegenerateWorkspaceHmacMutation,
      Record<string, never>
  ...
  async reindexKnowledgeSource(
    variables: ReindexKnowledgeSourceMutationVariables,
  ): Promise<ReindexKnowledgeSourceMutation["reindexKnowledgeSource"]> {
    const response = await this._client.request<
      ReindexKnowledgeSourceMutation,
      ReindexKnowledgeSourceMutationVariables
  ...
  async reloadCustomerCardInstance(
    variables: ReloadCustomerCardInstanceMutationVariables,
  ): Promise<ReloadCustomerCardInstanceMutation["reloadCustomerCardInstance"]> {
    const response = await this._client.request<
      ReloadCustomerCardInstanceMutation,
      ReloadCustomerCardInstanceMutationVariables
  ...
  async removeAdditionalAssignees(
    variables: RemoveAdditionalAssigneesMutationVariables,
  ): Promise<RemoveAdditionalAssigneesMutation["removeAdditionalAssignees"]> {
    const response = await this._client.request<
      RemoveAdditionalAssigneesMutation,
      RemoveAdditionalAssigneesMutationVariables
  ...
  async removeCustomerFromCustomerGroups(
    variables: RemoveCustomerFromCustomerGroupsMutationVariables,
  ): Promise<RemoveCustomerFromCustomerGroupsMutation["removeCustomerFromCustomerGroups"]> {
    const response = await this._client.request<
      RemoveCustomerFromCustomerGroupsMutation,
      RemoveCustomerFromCustomerGroupsMutationVariables
  ...
  async removeCustomerFromTenants(
    variables: RemoveCustomerFromTenantsMutationVariables,
  ): Promise<RemoveCustomerFromTenantsMutation["removeCustomerFromTenants"]> {
    const response = await this._client.request<
      RemoveCustomerFromTenantsMutation,
      RemoveCustomerFromTenantsMutationVariables
  ...
  async removeLabels(
    variables: RemoveLabelsMutationVariables,
  ): Promise<RemoveLabelsMutation["removeLabels"]> {
    const response = await this._client.request<
      RemoveLabelsMutation,
      RemoveLabelsMutationVariables
  ...
  async removeLabelsFromUser(
    variables: RemoveLabelsFromUserMutationVariables,
  ): Promise<RemoveLabelsFromUserMutation["removeLabelsFromUser"]> {
    const response = await this._client.request<
      RemoveLabelsFromUserMutation,
      RemoveLabelsFromUserMutationVariables
  ...
  async removeMembersFromTier(
    variables: RemoveMembersFromTierMutationVariables,
  ): Promise<RemoveMembersFromTierMutation["removeMembersFromTier"]> {
    const response = await this._client.request<
      RemoveMembersFromTierMutation,
      RemoveMembersFromTierMutationVariables
  ...
  async removeTenantFieldSchemaMapping(
    variables: RemoveTenantFieldSchemaMappingMutationVariables,
  ): Promise<RemoveTenantFieldSchemaMappingMutation["removeTenantFieldSchemaMapping"]> {
    const response = await this._client.request<
      RemoveTenantFieldSchemaMappingMutation,
      RemoveTenantFieldSchemaMappingMutationVariables
  ...
  async removeUserFromActiveBillingRota(
    variables: RemoveUserFromActiveBillingRotaMutationVariables,
  ): Promise<RemoveUserFromActiveBillingRotaMutation["removeUserFromActiveBillingRota"]> {
    const response = await this._client.request<
      RemoveUserFromActiveBillingRotaMutation,
      RemoveUserFromActiveBillingRotaMutationVariables
  ...
  async removeWorkspaceAlternateSupportEmailAddress(
    variables: RemoveWorkspaceAlternateSupportEmailAddressMutationVariables,
  ): Promise<
    RemoveWorkspaceAlternateSupportEmailAddressMutation["removeWorkspaceAlternateSupportEmailAddress"]
  > {
    const response = await this._client.request<
      RemoveWorkspaceAlternateSupportEmailAddressMutation,
      RemoveWorkspaceAlternateSupportEmailAddressMutationVariables
  ...
  async reorderAutoresponders(
    variables: ReorderAutorespondersMutationVariables,
  ): Promise<ReorderAutorespondersMutation["reorderAutoresponders"]> {
    const response = await this._client.request<
      ReorderAutorespondersMutation,
      ReorderAutorespondersMutationVariables
  ...
  async reorderCustomerCardConfigs(
    variables: ReorderCustomerCardConfigsMutationVariables,
  ): Promise<ReorderCustomerCardConfigsMutation["reorderCustomerCardConfigs"]> {
    const response = await this._client.request<
      ReorderCustomerCardConfigsMutation,
      ReorderCustomerCardConfigsMutationVariables
  ...
  async reorderCustomerSurveys(
    variables: ReorderCustomerSurveysMutationVariables,
  ): Promise<ReorderCustomerSurveysMutation["reorderCustomerSurveys"]> {
    const response = await this._client.request<
      ReorderCustomerSurveysMutation,
      ReorderCustomerSurveysMutationVariables
  ...
  async reorderThreadFieldSchemas(
    variables: ReorderThreadFieldSchemasMutationVariables,
  ): Promise<ReorderThreadFieldSchemasMutation["reorderThreadFieldSchemas"]> {
    const response = await this._client.request<
      ReorderThreadFieldSchemasMutation,
      ReorderThreadFieldSchemasMutationVariables
  ...
  async replyToEmail(
    variables: ReplyToEmailMutationVariables,
  ): Promise<ReplyToEmailMutation["replyToEmail"]> {
    const response = await this._client.request<
      ReplyToEmailMutation,
      ReplyToEmailMutationVariables
  ...
  async replyToThread(
    variables: ReplyToThreadMutationVariables,
  ): Promise<ReplyToThreadMutation["replyToThread"]> {
    const response = await this._client.request<
      ReplyToThreadMutation,
      ReplyToThreadMutationVariables
  ...
  async resolveCustomerForMSTeamsChannel(
    variables: ResolveCustomerForMsTeamsChannelMutationVariables,
  ): Promise<ResolveCustomerForMsTeamsChannelMutation["resolveCustomerForMSTeamsChannel"]> {
    const response = await this._client.request<
      ResolveCustomerForMsTeamsChannelMutation,
      ResolveCustomerForMsTeamsChannelMutationVariables
  ...
  async resolveCustomerForSlackChannel(
    variables: ResolveCustomerForSlackChannelMutationVariables,
  ): Promise<ResolveCustomerForSlackChannelMutation["resolveCustomerForSlackChannel"]> {
    const response = await this._client.request<
      ResolveCustomerForSlackChannelMutation,
      ResolveCustomerForSlackChannelMutationVariables
  ...
  async sendBulkEmail(
    variables: SendBulkEmailMutationVariables,
  ): Promise<SendBulkEmailMutation["sendBulkEmail"]> {
    const response = await this._client.request<
      SendBulkEmailMutation,
      SendBulkEmailMutationVariables
  ...
  async sendCustomerChat(
    variables: SendCustomerChatMutationVariables,
  ): Promise<SendCustomerChatMutation["sendCustomerChat"]> {
    const response = await this._client.request<
      SendCustomerChatMutation,
      SendCustomerChatMutationVariables
  ...
  async sendDiscordMessage(
    variables: SendDiscordMessageMutationVariables,
  ): Promise<SendDiscordMessageMutation["sendDiscordMessage"]> {
    const response = await this._client.request<
      SendDiscordMessageMutation,
      SendDiscordMessageMutationVariables
  ...
  async sendMSTeamsMessage(
    variables: SendMsTeamsMessageMutationVariables,
  ): Promise<SendMsTeamsMessageMutation["sendMSTeamsMessage"]> {
    const response = await this._client.request<
      SendMsTeamsMessageMutation,
      SendMsTeamsMessageMutationVariables
  ...
  async sendNewEmail(
    variables: SendNewEmailMutationVariables,
  ): Promise<SendNewEmailMutation["sendNewEmail"]> {
    const response = await this._client.request<
      SendNewEmailMutation,
      SendNewEmailMutationVariables
  ...
  async sendSlackMessage(
    variables: SendSlackMessageMutationVariables,
  ): Promise<SendSlackMessageMutation["sendSlackMessage"]> {
    const response = await this._client.request<
      SendSlackMessageMutation,
      SendSlackMessageMutationVariables
  ...
  async sendThreadDiscussionMessage(
    variables: SendThreadDiscussionMessageMutationVariables,
  ): Promise<SendThreadDiscussionMessageMutation["sendThreadDiscussionMessage"]> {
    const response = await this._client.request<
      SendThreadDiscussionMessageMutation,
      SendThreadDiscussionMessageMutationVariables
  ...
  async setCustomerTenants(
    variables: SetCustomerTenantsMutationVariables,
  ): Promise<SetCustomerTenantsMutation["setCustomerTenants"]> {
    const response = await this._client.request<
      SetCustomerTenantsMutation,
      SetCustomerTenantsMutationVariables
  ...
  async setupTenantFieldSchemaMapping(
    variables: SetupTenantFieldSchemaMappingMutationVariables,
  ): Promise<SetupTenantFieldSchemaMappingMutation["setupTenantFieldSchemaMapping"]> {
    const response = await this._client.request<
      SetupTenantFieldSchemaMappingMutation,
      SetupTenantFieldSchemaMappingMutationVariables
  ...
  async shareThreadToUserInSlack(
    variables: ShareThreadToUserInSlackMutationVariables,
  ): Promise<ShareThreadToUserInSlackMutation["shareThreadToUserInSlack"]> {
    const response = await this._client.request<
      ShareThreadToUserInSlackMutation,
      ShareThreadToUserInSlackMutationVariables
  ...
  async snoozeThread(
    variables: SnoozeThreadMutationVariables,
  ): Promise<SnoozeThreadMutation["snoozeThread"]> {
    const response = await this._client.request<
      SnoozeThreadMutation,
      SnoozeThreadMutationVariables
  ...
  async startServiceAuthorization(
    variables: StartServiceAuthorizationMutationVariables,
  ): Promise<StartServiceAuthorizationMutation["startServiceAuthorization"]> {
    const response = await this._client.request<
      StartServiceAuthorizationMutation,
      StartServiceAuthorizationMutationVariables
  ...
  async syncBusinessHoursSlots(
    variables: SyncBusinessHoursSlotsMutationVariables,
  ): Promise<SyncBusinessHoursSlotsMutation["syncBusinessHoursSlots"]> {
    const response = await this._client.request<
      SyncBusinessHoursSlotsMutation,
      SyncBusinessHoursSlotsMutationVariables
  ...
  async syncUserWorkingHours(
    variables: SyncUserWorkingHoursMutationVariables,
  ): Promise<SyncUserWorkingHoursMutation["syncUserWorkingHours"]> {
    const response = await this._client.request<
      SyncUserWorkingHoursMutation,
      SyncUserWorkingHoursMutationVariables
  ...
  async toggleSlackMessageReaction(
    variables: ToggleSlackMessageReactionMutationVariables,
  ): Promise<ToggleSlackMessageReactionMutation["toggleSlackMessageReaction"]> {
    const response = await this._client.request<
      ToggleSlackMessageReactionMutation,
      ToggleSlackMessageReactionMutationVariables
  ...
  async toggleWorkflowRulePublished(
    variables: ToggleWorkflowRulePublishedMutationVariables,
  ): Promise<ToggleWorkflowRulePublishedMutation["toggleWorkflowRulePublished"]> {
    const response = await this._client.request<
      ToggleWorkflowRulePublishedMutation,
      ToggleWorkflowRulePublishedMutationVariables
  ...
  async triggerWorkflow(
    variables: TriggerWorkflowMutationVariables,
  ): Promise<TriggerWorkflowMutation["triggerWorkflow"]> {
    const response = await this._client.request<
      TriggerWorkflowMutation,
      TriggerWorkflowMutationVariables
  ...
  async triggerWorkflowRule(
    variables: TriggerWorkflowRuleMutationVariables,
  ): Promise<TriggerWorkflowRuleMutation["triggerWorkflowRule"]> {
    const response = await this._client.request<
      TriggerWorkflowRuleMutation,
      TriggerWorkflowRuleMutationVariables
  ...
  async unarchiveLabelType(
    variables: UnarchiveLabelTypeMutationVariables,
  ): Promise<UnarchiveLabelTypeMutation["unarchiveLabelType"]> {
    const response = await this._client.request<
      UnarchiveLabelTypeMutation,
      UnarchiveLabelTypeMutationVariables
  ...
  async unassignThread(
    variables: UnassignThreadMutationVariables,
  ): Promise<UnassignThreadMutation["unassignThread"]> {
    const response = await this._client.request<
      UnassignThreadMutation,
      UnassignThreadMutationVariables
  ...
  async unmarkCustomerAsSpam(
    variables: UnmarkCustomerAsSpamMutationVariables,
  ): Promise<UnmarkCustomerAsSpamMutation["unmarkCustomerAsSpam"]> {
    const response = await this._client.request<
      UnmarkCustomerAsSpamMutation,
      UnmarkCustomerAsSpamMutationVariables
  ...
  async updateActiveBillingRota(
    variables: UpdateActiveBillingRotaMutationVariables,
  ): Promise<UpdateActiveBillingRotaMutation["updateActiveBillingRota"]> {
    const response = await this._client.request<
      UpdateActiveBillingRotaMutation,
      UpdateActiveBillingRotaMutationVariables
  ...
  async updateAiToneRules(
    variables: UpdateAiToneRulesMutationVariables,
  ): Promise<UpdateAiToneRulesMutation["updateAiToneRules"]> {
    const response = await this._client.request<
      UpdateAiToneRulesMutation,
      UpdateAiToneRulesMutationVariables
  ...
  ): Promise<UpdateApiKeyMutation["updateApiKey"]> {
    const response = await this._client.request<
      UpdateApiKeyMutation,
      UpdateApiKeyMutationVariables
  ...
  async updateAutoresponder(
    variables: UpdateAutoresponderMutationVariables,
  ): Promise<UpdateAutoresponderMutation["updateAutoresponder"]> {
    const response = await this._client.request<
      UpdateAutoresponderMutation,
      UpdateAutoresponderMutationVariables
  ...
  async updateChatApp(
    variables: UpdateChatAppMutationVariables,
  ): Promise<UpdateChatAppMutation["updateChatApp"]> {
    const response = await this._client.request<
      UpdateChatAppMutation,
      UpdateChatAppMutationVariables
  ...
  async updateCompanyTier(
    variables: UpdateCompanyTierMutationVariables,
  ): Promise<UpdateCompanyTierMutation["updateCompanyTier"]> {
    const response = await this._client.request<
      UpdateCompanyTierMutation,
      UpdateCompanyTierMutationVariables
  ...
  async updateConnectedDiscordChannel(
    variables: UpdateConnectedDiscordChannelMutationVariables,
  ): Promise<UpdateConnectedDiscordChannelMutation["updateConnectedDiscordChannel"]> {
    const response = await this._client.request<
      UpdateConnectedDiscordChannelMutation,
      UpdateConnectedDiscordChannelMutationVariables
  ...
  async updateConnectedSlackChannel(
    variables: UpdateConnectedSlackChannelMutationVariables,
  ): Promise<UpdateConnectedSlackChannelMutation["updateConnectedSlackChannel"]> {
    const response = await this._client.request<
      UpdateConnectedSlackChannelMutation,
      UpdateConnectedSlackChannelMutationVariables
  ...
  async updateCustomRole(
    variables: UpdateCustomRoleMutationVariables,
  ): Promise<UpdateCustomRoleMutation["updateCustomRole"]> {
    const response = await this._client.request<
      UpdateCustomRoleMutation,
      UpdateCustomRoleMutationVariables
  ...
  async updateCustomerCardConfig(
    variables: UpdateCustomerCardConfigMutationVariables,
  ): Promise<UpdateCustomerCardConfigMutation["updateCustomerCardConfig"]> {
    const response = await this._client.request<
      UpdateCustomerCardConfigMutation,
      UpdateCustomerCardConfigMutationVariables
  ...
  async updateCustomerCompany(
    variables: UpdateCustomerCompanyMutationVariables,
  ): Promise<UpdateCustomerCompanyMutation["updateCustomerCompany"]> {
    const response = await this._client.request<
      UpdateCustomerCompanyMutation,
      UpdateCustomerCompanyMutationVariables
  ...
  ): Promise<UpdateCustomerGroupMutation["updateCustomerGroup"]> {
    const response = await this._client.request<
      UpdateCustomerGroupMutation,
      UpdateCustomerGroupMutationVariables
  ...
  async updateCustomerSurvey(
    variables: UpdateCustomerSurveyMutationVariables,
  ): Promise<UpdateCustomerSurveyMutation["updateCustomerSurvey"]> {
    const response = await this._client.request<
      UpdateCustomerSurveyMutation,
      UpdateCustomerSurveyMutationVariables
  ...
  async updateEscalationPath(
    variables: UpdateEscalationPathMutationVariables,
  ): Promise<UpdateEscalationPathMutation["updateEscalationPath"]> {
    const response = await this._client.request<
      UpdateEscalationPathMutation,
      UpdateEscalationPathMutationVariables
  ...
  async updateGeneratedReply(
    variables: UpdateGeneratedReplyMutationVariables,
  ): Promise<UpdateGeneratedReplyMutation["updateGeneratedReply"]> {
    const response = await this._client.request<
      UpdateGeneratedReplyMutation,
      UpdateGeneratedReplyMutationVariables
  ...
  async updateHelpCenter(
    variables: UpdateHelpCenterMutationVariables,
  ): Promise<UpdateHelpCenterMutation["updateHelpCenter"]> {
    const response = await this._client.request<
      UpdateHelpCenterMutation,
      UpdateHelpCenterMutationVariables
  ...
  async updateHelpCenterArticleGroup(
    variables: UpdateHelpCenterArticleGroupMutationVariables,
  ): Promise<UpdateHelpCenterArticleGroupMutation["updateHelpCenterArticleGroup"]> {
    const response = await this._client.request<
      UpdateHelpCenterArticleGroupMutation,
      UpdateHelpCenterArticleGroupMutationVariables
  ...
  async updateHelpCenterCustomDomainName(
    variables: UpdateHelpCenterCustomDomainNameMutationVariables,
  ): Promise<UpdateHelpCenterCustomDomainNameMutation["updateHelpCenterCustomDomainName"]> {
    const response = await this._client.request<
      UpdateHelpCenterCustomDomainNameMutation,
      UpdateHelpCenterCustomDomainNameMutationVariables
  ...
  async updateHelpCenterIndex(
    variables: UpdateHelpCenterIndexMutationVariables,
  ): Promise<UpdateHelpCenterIndexMutation["updateHelpCenterIndex"]> {
    const response = await this._client.request<
      UpdateHelpCenterIndexMutation,
      UpdateHelpCenterIndexMutationVariables
  ...
  async updateInternalNotifications(
    variables: UpdateInternalNotificationsMutationVariables,
  ): Promise<UpdateInternalNotificationsMutation["updateInternalNotifications"]> {
    const response = await this._client.request<
      UpdateInternalNotificationsMutation,
      UpdateInternalNotificationsMutationVariables
  ...
  async updateLabelType(
    variables: UpdateLabelTypeMutationVariables,
  ): Promise<UpdateLabelTypeMutation["updateLabelType"]> {
    const response = await this._client.request<
      UpdateLabelTypeMutation,
      UpdateLabelTypeMutationVariables
  ...
  async updateMachineUser(
    variables: UpdateMachineUserMutationVariables,
  ): Promise<UpdateMachineUserMutation["updateMachineUser"]> {
    const response = await this._client.request<
      UpdateMachineUserMutation,
      UpdateMachineUserMutationVariables
  ...
  async updateMyUser(
    variables: UpdateMyUserMutationVariables,
  ): Promise<UpdateMyUserMutation["updateMyUser"]> {
    const response = await this._client.request<
      UpdateMyUserMutation,
      UpdateMyUserMutationVariables
  ...
  ): Promise<UpdateNoteMutation["updateNote"]> {
  ...
  async updateSavedThreadsView(
    variables: UpdateSavedThreadsViewMutationVariables,
  ): Promise<UpdateSavedThreadsViewMutation["updateSavedThreadsView"]> {
    const response = await this._client.request<
      UpdateSavedThreadsViewMutation,
      UpdateSavedThreadsViewMutationVariables
  ...
  async updateServiceLevelAgreement(
    variables: UpdateServiceLevelAgreementMutationVariables,
  ): Promise<UpdateServiceLevelAgreementMutation["updateServiceLevelAgreement"]> {
    const response = await this._client.request<
      UpdateServiceLevelAgreementMutation,
      UpdateServiceLevelAgreementMutationVariables
  ...
  ): Promise<UpdateSettingMutation["updateSetting"]> {
    const response = await this._client.request<
      UpdateSettingMutation,
      UpdateSettingMutationVariables
  ...
  async updateSnippet(
    variables: UpdateSnippetMutationVariables,
  ): Promise<UpdateSnippetMutation["updateSnippet"]> {
    const response = await this._client.request<
      UpdateSnippetMutation,
      UpdateSnippetMutationVariables
  ...
  ): Promise<UpdateTaskMutation["updateTask"]> {
  ...
  async updateTenantTier(
    variables: UpdateTenantTierMutationVariables,
  ): Promise<UpdateTenantTierMutation["updateTenantTier"]> {
    const response = await this._client.request<
      UpdateTenantTierMutation,
      UpdateTenantTierMutationVariables
  ...
  async updateThreadAgentStatus(
    variables: UpdateThreadAgentStatusMutationVariables,
  ): Promise<UpdateThreadAgentStatusMutation["updateThreadAgentStatus"]> {
    const response = await this._client.request<
      UpdateThreadAgentStatusMutation,
      UpdateThreadAgentStatusMutationVariables
  ...
  async updateThreadEscalationPath(
    variables: UpdateThreadEscalationPathMutationVariables,
  ): Promise<UpdateThreadEscalationPathMutation["updateThreadEscalationPath"]> {
    const response = await this._client.request<
      UpdateThreadEscalationPathMutation,
      UpdateThreadEscalationPathMutationVariables
  ...
  async updateThreadFieldSchema(
    variables: UpdateThreadFieldSchemaMutationVariables,
  ): Promise<UpdateThreadFieldSchemaMutation["updateThreadFieldSchema"]> {
    const response = await this._client.request<
      UpdateThreadFieldSchemaMutation,
      UpdateThreadFieldSchemaMutationVariables
  ...
  async updateThreadSuggestedActionStatus(
    variables: UpdateThreadSuggestedActionStatusMutationVariables,
  ): Promise<UpdateThreadSuggestedActionStatusMutation["updateThreadSuggestedActionStatus"]> {
    const response = await this._client.request<
      UpdateThreadSuggestedActionStatusMutation,
      UpdateThreadSuggestedActionStatusMutationVariables
  ...
  async updateThreadTenant(
    variables: UpdateThreadTenantMutationVariables,
  ): Promise<UpdateThreadTenantMutation["updateThreadTenant"]> {
    const response = await this._client.request<
      UpdateThreadTenantMutation,
      UpdateThreadTenantMutationVariables
  ...
  async updateThreadTier(
    variables: UpdateThreadTierMutationVariables,
  ): Promise<UpdateThreadTierMutation["updateThreadTier"]> {
    const response = await this._client.request<
      UpdateThreadTierMutation,
      UpdateThreadTierMutationVariables
  ...
  async updateThreadTitle(
    variables: UpdateThreadTitleMutationVariables,
  ): Promise<UpdateThreadTitleMutation["updateThreadTitle"]> {
    const response = await this._client.request<
      UpdateThreadTitleMutation,
      UpdateThreadTitleMutationVariables
  ...
  ): Promise<UpdateTierMutation["updateTier"]> {
  ...
  async updateUserDefaultSavedThreadsView(
    variables: UpdateUserDefaultSavedThreadsViewMutationVariables,
  ): Promise<UpdateUserDefaultSavedThreadsViewMutation["updateUserDefaultSavedThreadsView"]> {
    const response = await this._client.request<
      UpdateUserDefaultSavedThreadsViewMutation,
      UpdateUserDefaultSavedThreadsViewMutationVariables
  ...
  async updateWebhookTarget(
    variables: UpdateWebhookTargetMutationVariables,
  ): Promise<UpdateWebhookTargetMutation["updateWebhookTarget"]> {
    const response = await this._client.request<
      UpdateWebhookTargetMutation,
      UpdateWebhookTargetMutationVariables
  ...
  ): Promise<UpdateWorkflowMutation["updateWorkflow"]> {
    const response = await this._client.request<
      UpdateWorkflowMutation,
      UpdateWorkflowMutationVariables
  ...
  async updateWorkflowRule(
    variables: UpdateWorkflowRuleMutationVariables,
  ): Promise<UpdateWorkflowRuleMutation["updateWorkflowRule"]> {
    const response = await this._client.request<
      UpdateWorkflowRuleMutation,
      UpdateWorkflowRuleMutationVariables
  ...
  async updateWorkflowStep(
    variables: UpdateWorkflowStepMutationVariables,
  ): Promise<UpdateWorkflowStepMutation["updateWorkflowStep"]> {
    const response = await this._client.request<
      UpdateWorkflowStepMutation,
      UpdateWorkflowStepMutationVariables
  ...
  async updateWorkspace(
    variables: UpdateWorkspaceMutationVariables,
  ): Promise<UpdateWorkspaceMutation["updateWorkspace"]> {
    const response = await this._client.request<
      UpdateWorkspaceMutation,
      UpdateWorkspaceMutationVariables
  ...
  async updateWorkspaceEmailSettings(
    variables: UpdateWorkspaceEmailSettingsMutationVariables,
  ): Promise<UpdateWorkspaceEmailSettingsMutation["updateWorkspaceEmailSettings"]> {
    const response = await this._client.request<
      UpdateWorkspaceEmailSettingsMutation,
      UpdateWorkspaceEmailSettingsMutationVariables
  ...
  async upsertBusinessHours(
    variables: UpsertBusinessHoursMutationVariables,
  ): Promise<UpsertBusinessHoursMutation["upsertBusinessHours"]> {
    const response = await this._client.request<
      UpsertBusinessHoursMutation,
      UpsertBusinessHoursMutationVariables
  ...
  async upsertCompany(
    variables: UpsertCompanyMutationVariables,
  ): Promise<UpsertCompanyMutation["upsertCompany"]> {
    const response = await this._client.request<
      UpsertCompanyMutation,
      UpsertCompanyMutationVariables
  ...
  async upsertCustomer(
    variables: UpsertCustomerMutationVariables,
  ): Promise<UpsertCustomerMutation["upsertCustomer"]> {
    const response = await this._client.request<
      UpsertCustomerMutation,
      UpsertCustomerMutationVariables
  ...
  async upsertCustomerGroup(
    variables: UpsertCustomerGroupMutationVariables,
  ): Promise<UpsertCustomerGroupMutation["upsertCustomerGroup"]> {
    const response = await this._client.request<
      UpsertCustomerGroupMutation,
      UpsertCustomerGroupMutationVariables
  ...
  async upsertHelpCenterArticle(
    variables: UpsertHelpCenterArticleMutationVariables,
  ): Promise<UpsertHelpCenterArticleMutation["upsertHelpCenterArticle"]> {
    const response = await this._client.request<
      UpsertHelpCenterArticleMutation,
      UpsertHelpCenterArticleMutationVariables
  ...
  async upsertMyEmailSignature(
    variables: UpsertMyEmailSignatureMutationVariables,
  ): Promise<UpsertMyEmailSignatureMutation["upsertMyEmailSignature"]> {
    const response = await this._client.request<
      UpsertMyEmailSignatureMutation,
      UpsertMyEmailSignatureMutationVariables
  ...
  async upsertRoleScopes(
    variables: UpsertRoleScopesMutationVariables,
  ): Promise<UpsertRoleScopesMutation["upsertRoleScopes"]> {
    const response = await this._client.request<
      UpsertRoleScopesMutation,
      UpsertRoleScopesMutationVariables
  ...
  async upsertTeamSettings(
    variables: UpsertTeamSettingsMutationVariables,
  ): Promise<UpsertTeamSettingsMutation["upsertTeamSettings"]> {
    const response = await this._client.request<
      UpsertTeamSettingsMutation,
      UpsertTeamSettingsMutationVariables
  ...
  async upsertTenant(
    variables: UpsertTenantMutationVariables,
  ): Promise<UpsertTenantMutation["upsertTenant"]> {
    const response = await this._client.request<
      UpsertTenantMutation,
      UpsertTenantMutationVariables
  ...
  async upsertTenantField(
    variables: UpsertTenantFieldMutationVariables,
  ): Promise<UpsertTenantFieldMutation["upsertTenantField"]> {
    const response = await this._client.request<
      UpsertTenantFieldMutation,
      UpsertTenantFieldMutationVariables
  ...
  async upsertTenantFieldSchema(
    variables: UpsertTenantFieldSchemaMutationVariables,
  ): Promise<UpsertTenantFieldSchemaMutation["upsertTenantFieldSchema"]> {
    const response = await this._client.request<
      UpsertTenantFieldSchemaMutation,
      UpsertTenantFieldSchemaMutationVariables
  ...
  async upsertThreadField(
    variables: UpsertThreadFieldMutationVariables,
  ): Promise<UpsertThreadFieldMutation["upsertThreadField"]> {
    const response = await this._client.request<
      UpsertThreadFieldMutation,
      UpsertThreadFieldMutationVariables
  ...
  async verifyHelpCenterCustomDomainName(
    variables: VerifyHelpCenterCustomDomainNameMutationVariables,
  ): Promise<VerifyHelpCenterCustomDomainNameMutation["verifyHelpCenterCustomDomainName"]> {
    const response = await this._client.request<
      VerifyHelpCenterCustomDomainNameMutation,
      VerifyHelpCenterCustomDomainNameMutationVariables
  ...
  async verifyWorkspaceEmailDnsSettings(): Promise<
    VerifyWorkspaceEmailDnsSettingsMutation["verifyWorkspaceEmailDnsSettings"]
  > {
    const response = await this._client.request<
      VerifyWorkspaceEmailDnsSettingsMutation,
      Record<string, never>
  ...
  async verifyWorkspaceEmailForwardingSettings(
    variables: VerifyWorkspaceEmailForwardingSettingsMutationVariables,
  ): Promise<
    VerifyWorkspaceEmailForwardingSettingsMutation["verifyWorkspaceEmailForwardingSettings"]
  > {
    const response = await this._client.request<
      VerifyWorkspaceEmailForwardingSettingsMutation,
      VerifyWorkspaceEmailForwardingSettingsMutationVariables
